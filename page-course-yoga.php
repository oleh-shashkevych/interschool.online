                    ...
                    <div class="io-sidebar__inner">
                        <section class="io-course-passport">
                            ...
                            <div class="io-course-passport__header">
                                <span class="io-course-passport__header-title"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Курс йоги'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Yoga course'; } ?></span>
                        ...
                        <div class="tab-pane fade show active" id="<?php echo $ioTab1; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab1; ?>-tab">
                            <div>
                                <section class="io-intersection io-course-hero">
                                    <h1 class="io-heading-1 io-course-hero__heading"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Уроки<br><span class="io-pink-main">Йоги</span><br>Oнлайн'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Online<br><span class="io-pink-main">Yoga</span><br>Lessons'; } ?></h1>
                                    ...
                                    <div class="io-course-hero__rating io-rating">
                                        ...
                                        <div class="io-rating__bottom">
                                            <div class="io-rating__bottom-left">
                                                ...
                                                <span>+42 <?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'отзыва'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'reviews'; } ?></span>
                                            </div>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioGiftCourseCheck-collapseFive" class="accordion-collapse collapse show" aria-labelledby="ioGiftCourseCheck-headingFive">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-radio" type="radio" id="iocheckboxgift53" name="checkbox-group" checked>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioDemoCourseCheck-collapseFive" class="accordion-collapse collapse show" aria-labelledby="ioDemoCourseCheck-headingFive">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-checkbox" type="checkbox" id="iocheckbox53" name="checkbox-group" checked>
...
<script>
    ...
    var scrollImageRu = '/wp-content/uploads/2023/11/Йога-Онлайн.svg';
    var scrollImageEn = '/wp-content/uploads/2023/11/Yoga-Online.svg';
