    ...
    if (ICL_LANGUAGE_CODE === 'ru') {
        ...
        $contentTab3 = '
            <section class="io-intersection io-course-lectors">
                <h2 class="io-heading-2 io-course-lectors__heading">Преподаватели живописи</h2>
                <div class="io-course-lectors__text-wrapper io-text-wrapper">
                    <div class="io-check io-check--start">
                        <span>Каждый преподаватель живописи в нашей онлайн-школе искусств обладает высшим художественным образованием и богатым опытом работы как с детьми, так и со взрослыми. </span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Наши учителя не только передают знания, но и помогают раскрыть индивидуальный творческий потенциал каждого студента. </span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Педагоги активно участвуют в художественной жизни, регулярно выставляют свои работы и продолжают самостоятельно исследовать различные стили и техники, что делает их истинными мастерами своего дела.</span>
                    </div>
                </div>
        ...
        $contentTab3 = '
            <section class="io-intersection io-course-lectors">
                ...
                <div class="io-course-lectors__text-wrapper io-text-wrapper">
                    <div class="io-check io-check--start">
                        <span>Every painting teacher at our online art school possesses a higher education in fine arts and extensive experience working with both children and adults.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Our teachers not only impart knowledge but also assist in unlocking the individual creative potential of each student.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Our educators actively participate in the art community, regularly exhibit their works, and continue to independently explore various styles and techniques, making them true masters of their craft.</span>
                    </div>
                </div>
                <div class="io-course-lectors__item io-block">
                    <div class="io-course-lectors__item-header">
                    ...
                    <div class="io-sidebar__inner">
                        <section class="io-course-passport">
                            ...
                            <div class="io-course-passport__header">
                                <span class="io-course-passport__header-title"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Курс живописи'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Painting course'; } ?></span>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="<?php echo $ioTab1; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab1; ?>-tab">
                            <div>
                                <section class="io-intersection io-course-hero">
                                    <h1 class="io-heading-1 io-course-hero__heading"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Уроки<br><span class="io-pink-main">Живописи</span><br>Oнлайн'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Online<br><span class="io-pink-main">Painting</span><br>Lessons'; } ?></h1>
                                    ...
                                    <div class="io-course-hero__rating io-rating">
                                        ...
                                        <div class="io-rating__bottom">
                                            <div class="io-rating__bottom-left">
                                                ...
                                                <span>+146 <?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'отзывов'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'reviews'; } ?></span>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="<?php echo $ioTab2; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab2; ?>-tab">
                            ...
                            <section class="io-intersection io-course-lesson">
                                <h2 class="io-heading-2 io-course-lesson__heading">Как проходят уроки живописи</h2>
                                <div class="io-video">
                                ...
                                <div class="io-steps__wrapper">
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Оборудование:</span> для участия в онлайн-уроках вам понадобится устройство с возможностью подключения к интернету и встроенной или внешней камерой — компьютер, планшет или смартфон.</p>
                                            ...
                                            <p><span class="io-fw-semibold">Платформа для видеоконференций:</span> уроки проводятся через платформы такие как Zoom или Google Meet. Пожалуйста, установите и настройте необходимое программное обеспечение заблаговременно. Проверьте работу видео и аудио на вашем устройстве перед уроком.</p>
                                    ...
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            ...
                                            <p><span class="io-fw-semibold">Материалы для урока:</span> Бумага: для работы с красками используйте плотную бумагу, способную впитывать влагу без деформации. Для рисования простым карандашом или другими сухими материалами подойдет любая бумага, которая у вас есть. Другие инструменты для рисования: подготовьте простой карандаш и ластик для создания эскизов. Вы можете использовать любые доступные художественные материалы для заполнения эскиза — цветные карандаши, маркеры, краски.</p>
                                            <p><span class="io-fw-semibold">Дополнительные материалы для работы с красками:</span> Емкость с водой: подготовьте небольшую емкость для ополаскивания кистей. Кисточки: необходимы две-три кисточки разной толщины для разнообразия мазков. Палитра: для смешивания красок подойдет специальная палитра или просто гладкая непористая поверхность.</p>
                                            <p><span class="io-fw-semibold">Настройка рабочего места:</span> Размещение устройства: установите ваше устройство так, чтобы преподаватель мог четко видеть вас и вашу рабочую зону. Это поможет ему лучше оценивать вашу технику и давать коррективы в реальном времени. Тестирование техники: за 10-15 минут до начала занятия войдите в приложение Zoom или Google Meet по полученной ссылке. Проверьте, что ваша камера и микрофон работают корректно, и что интернет-соединение стабильно.</p>
                                            <p>Эти подготовительные шаги помогут обеспечить бесперебойное и продуктивное проведение уроков живописи.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Инструкции и обратная связь:</span> ваш преподаватель по живописи предоставит детальные инструкции по использованию различных техник рисования и подходам к композиции. Вы получите обратную связь, которая поможет вам улучшить свои навыки.</p>
                                            ...
                                            <p><span class="io-fw-semibold">Практика:</span> большая часть урока посвящена практическому рисованию. Вы будете создавать собственные работы, а преподаватель будет наблюдать и давать рекомендации по улучшению вашей техники.</p>
                                            <p><span class="io-fw-semibold">Демонстрация техник преподавателем:</span> преподаватель будет создавать картину параллельно с вами, что поможет вам лучше понять, как достигать желаемых эффектов в своих работах.</p>
                                    ...
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p>Материалы для самостоятельной работы: преподаватель предоставит вам материалы для домашней практики, включая рекомендации по техникам рисования, примеры работ и дополнительные ресурсы для глубокого изучения живописи.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps io-steps--last">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p class="io-purple-main io-fs-18 io-fw-semibold">Мы убеждены, что онлайн-уроки живописи обеспечат вам комфорт и результативность в обучении. Ваш образовательный опыт окажется увлекательным и продуктивным!</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            <?php } elseif (ICL_LANGUAGE_CODE === 'en') { ?>
                            <section class="io-intersection io-course-lesson">
                                <h2 class="io-heading-2 io-course-lesson__heading">How Online Painting Classes Work</h2>
                                <div class="io-video">
                                ...
                                <div class="io-steps__wrapper">
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Device Requirements:</span> To participate in online classes, you will need a device with internet connectivity and a built-in or external camera—such as a computer, tablet, or smartphone.</p>
                                            <p><span class="io-fw-semibold">Internet Connection:</span> A stable and fast internet connection is crucial for a quality learning experience. We recommend conducting an internet speed test before the class starts to prevent interruptions during your session with the instructor.</p>
                                            <p><span class="io-fw-semibold">Video Conferencing Platform:</span> Classes are conducted via platforms like Zoom or Google Meet. Please install and configure the necessary software in advance. Check your video and audio functionality on your device before the lesson.</p>
                                            <p><span class="io-fw-semibold">Sound:</span> For better audibility and to minimize background noise, we strongly recommend using high-quality headphones with a microphone. This will enhance the audio interaction and allow you to hear the instructor's guidance and comments more clearly.</p>
                                            <p><span class="io-fw-semibold">Lighting and Workspace:</span> Ensure your workspace is well-lit so the instructor can clearly see your work and provide constructive feedback. Ideally, use a bright light source directed at your work area without causing glare on the screen or work materials.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">2</div>
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Lesson Link:</span> The link to the online session will be sent to you well in advance via email or your preferred messenger service. Please ensure you have received the link a day before the lesson starts.</p>
                                            <p><span class="io-fw-semibold">Lesson Materials:</span> Paper: Use thick paper for painting to absorb moisture without warping. For drawing with pencils or other dry materials, any available paper will suffice. Drawing Instruments: Prepare a regular pencil and eraser for sketches. You may use any art materials you have at home to fill in the sketches—colored pencils, markers, paints.</p>
                                            <p><span class="io-fw-semibold">Additional Materials for Painting:</span> Water Container: Prepare a small container for rinsing brushes. Brushes: You will need two to three brushes of different thicknesses to achieve various strokes. Palette: A specialized palette or any smooth, non-porous surface is suitable for mixing paints.</p>
                                            <p><span class="io-fw-semibold">Workspace Setup:</span> Device Placement: Position your device so the instructor can clearly see you and your work area. This will help them better assess your technique and provide real-time corrections. Technical Testing: Enter the Zoom or Google Meet app using the provided link 10-15 minutes before the class starts. Check that your camera and microphone are working correctly and that your internet connection is stable.</p>
                                            <p>These preparatory steps will ensure a smooth and productive painting lesson.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">3</div>
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Instructions and Feedback:</span> Your painting instructor will provide detailed instructions on various drawing techniques and approaches to composition. You will receive feedback that will help improve your skills.</p>
                                            <p><span class="io-fw-semibold">Ask Questions:</span> Do not hesitate to ask your teacher about any aspects of the technique or challenges you encounter. Your instructor is ready to help you understand all your queries.</p>
                                            <p><span class="io-fw-semibold">Practice:</span> A significant portion of the lesson is dedicated to practical drawing. You will create your own works while the instructor observes and offers suggestions for enhancing your technique.</p>
                                            <p><span class="io-fw-semibold">Instructor Demonstrations:</span> The instructor will concurrently create a painting with you, helping you better understand how to achieve the desired effects in your works.</p>
                                            <p><span class="io-fw-semibold">Lesson Conclusion:</span> At the end of the lesson, you will discuss the techniques learned, receive homework assignments, and set plans for future sessions.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">4</div>
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p>Materials for Independent Practice: The instructor will provide you with materials for home practice, including recommendations on drawing techniques, examples of artwork, and additional resources for an in-depth study of painting.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps io-steps--last">
                                        <div class="io-steps__empty">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p class="io-purple-main io-fs-18 io-fw-semibold">We are confident that online painting lessons will provide you with both convenience and effectiveness in learning. Your educational experience will be engaging and productive!</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                        ...
                        <div class="tab-pane fade" id="<?php echo $ioTab4; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab4; ?>-tab">
                            ...
                            <section class="io-intersection io-course-programs">
                                <h2 class="io-heading-2">Программа курса живописи</h2>
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--preschool">
                                        <div class="io-course-programs__data io-course-programs__data--preschool">
                                            ...
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-none d-sm-flex">
                                                ...
                                                <picture>                                                    
                                                    <source srcset="/wp-content/uploads/2024/05/art-1.png" type="image/png">
                                                    <img class="d-none" src="/wp-content/uploads/2024/05/art-1.png" alt="">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="io-course-programs__content io-course-programs__content--preschool">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>п1</span>
                                                <p>Создание простых работ, используя гуашь.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>п2</span>
                                                <p>Практика смешивания красок. Создание различных оттенков и цветовых пятен.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>п3</span>
                                                <p>Рисование по воображению простых объектов: деревья, цветы, животные, сказочные герои.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>п4</span>
                                                <p>Создание простых конкурсных работ и участие в конкурсе или выставке.</p>
                                            </div>
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--light">
                                        <div class="io-course-programs__data io-course-programs__data--light">
                                            ...
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-none d-sm-flex">
                                                <span>Смотреть диплом</span>
                                                <picture>                                                    
                                                    <source srcset="/wp-content/uploads/2024/05/art-2.png" type="image/png">
                                                    <img class="d-none" src="/wp-content/uploads/2024/05/art-2.png" alt="">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="io-course-programs__content io-course-programs__content--light">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>1</span>
                                                <p>Создание простых работ, используя различные материалы и техники (гуашь, акварель, пастель, карандаши).</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>2</span>
                                                <p>Обучение основам теории цвета. Практика смешивания красок. Создание различных оттенков, где ключевое внимание уделяется теплохолодности работ.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>3</span>
                                                <p>рисование основных геометрических форм, размещение фигур в пространстве с учетом перспективы и тени.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>4</span>
                                                <p>Рисования с натуры, по памяти, по воображению простых объектов природы: деревья, цветы, животные, сказочные герои.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>5</span>
                                                <p>Создание серии композиционных работ на тему природы.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>6</span>
                                                <p>Создание конкурсных работ и участие в конкурсе или выставке.</p>
                                            </div>
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-sm-none">
                                                <span>Смотреть диплом</span>
                                                <picture>                                                    
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--medium">
                                        <div class="io-course-programs__data io-course-programs__data--medium">
                                            ...
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-none d-sm-flex">
                                                <span>Смотреть диплом</span>
                                                <picture>                                                    
                                                    <source srcset="/wp-content/uploads/2024/05/art-3.png" type="image/png">
                                                    <img class="d-none" src="/wp-content/uploads/2024/05/art-3.png" alt="">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="io-course-programs__content io-course-programs__content--medium">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>7</span>
                                                <p>Изучение ключевых эпох и стилей в искусстве. Практика рисования, имитируя различные стили и техники.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>8</span>
                                                <p>Создание серии работ в стиле выбранной эпохи.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>9</span>
                                                <p>Изучение основ рисования натюрморта, понятие композиции, формы и объема. Изучение техники светотени в натюрморте. Создание серии натюрмортов различными материалами и техниками.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>10</span>
                                                <p>Создание конкурсных работ и участие в конкурсе или выставке.</p>
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--hard">
                                        <div class="io-course-programs__data io-course-programs__data--hard">
                                            ...
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-none d-sm-flex">
                                                <span>Смотреть диплом</span>
                                                <picture>                                                    
                                                    <source srcset="/wp-content/uploads/2024/05/art-4.png" type="image/png">
                                                    <img class="d-none" src="/wp-content/uploads/2024/05/art-4.png" alt="">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="io-course-programs__content io-course-programs__content--hard">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>11</span>
                                                <p>Изучение принципов композиции, перспективы и светотени в пейзаже. Работа над пейзажами различных видов. Создание серии пейзажей, отражающих различные времена года, время и место.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>12</span>
                                                <p>Изучение основ рисования портрета и человеческой фигуры. Создание серии портретов и фигур в различных стилях и техниках. </p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>13</span>
                                                <p>Изучение абстрактного искусства, его основных принципов и выдающихся художников. Эксперименты с цветом, формой и композицией в контексте абстрактного искусства. Практика создания абстрактных работ и развитие собственного стиля. </p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>14</span>
                                                <p>Подготовка и проведение выставки. Создание портфолио работ. Организация и проведение персональной выставки в школе искусств. Участие в конкурсах и выставках.</p>
                                            </div>
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-sm-none">
                                                <span>Смотреть диплом</span>
                                                <picture>                                                    
                                ...
                                <div class="io-text-wrapper">
                                    <p>Программа курса живописи охватывает все ключевые аспекты искусства от начального до продвинутого уровня, предоставляя студентам возможность развивать навыки в различных техниках и стилях. Включение элементов теории и практики, а также возможность участвовать в выставках и конкурсах, обеспечивает комплексное и глубокое обучение. Эта программа не только способствует техническому мастерству, но и стимулирует креативное и критическое мышление у студентов, подготавливая их к продвинутым уровням художественного творчества и самовыражения.</p>
                            ...
                            <?php } elseif (ICL_LANGUAGE_CODE === 'en') { ?>
                            <section class="io-intersection io-course-programs">
                                <h2 class="io-heading-2">Painting Course Program</h2>
                                <div class="io-course-programs__grid">
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--preschool">
                                        ...
                                        <div class="io-course-programs__content io-course-programs__content--preschool">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>p1</span>
                                                <p>Creating simple works using gouache.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>p2</span>
                                                <p>Practice mixing paints. Creating various shades and color patches.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>p3</span>
                                                <p>Drawing simple objects from imagination: trees, flowers, animals, fairy-tale characters.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>p4</span>
                                                <p>Creating simple competition pieces and participating in a contest or exhibition.</p>
                                            </div>
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-sm-none">
                                                <span>View Diploma</span>
                                                <picture>                                                    
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--light">
                                        ...
                                        <div class="io-course-programs__content io-course-programs__content--light">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>1</span>
                                                <p>Creating simple works using various materials and techniques (gouache, watercolor, pastel, pencils).</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>2</span>
                                                <p>Learning the basics of color theory. Practice in mixing paints, focusing on creating various shades, with emphasis on warm and cool tones. </p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>3</span>
                                                <p>Drawing basic geometric shapes, placing figures in space considering perspective and shadows.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>4</span>
                                                <p>Drawing from life, memory, and imagination of simple natural objects: trees, flowers, animals, fairy-tale characters.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>5</span>
                                                <p>Creating a series of compositional works on the theme of nature. </p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>6</span>
                                                <p>Creating competition pieces and participating in a contest or exhibition.</p>
                                            </div>
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-sm-none">
                                                <span>View Diploma</span>
                                                <picture>                                                    
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--medium">
                                        ...
                                        <div class="io-course-programs__content io-course-programs__content--medium">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>7</span>
                                                <p>Studying key eras and styles in art. Practice drawing, imitating various styles and techniques.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>8</span>
                                                <p>Creating a series of works in the style of a chosen era.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>9</span>
                                                <p>Learning the basics of still life drawing, concepts of composition, form, and volume. Studying the technique of chiaroscuro in still life. Creating a series of still lifes with various materials and techniques.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>10</span>
                                                <p>Creating competition pieces and participating in a contest or exhibition.</p>
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--hard">
                                        ...
                                        <div class="io-course-programs__content io-course-programs__content--hard">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>11</span>
                                                <p>11 Studying the principles of composition, perspective, and chiaroscuro in landscape. Working on landscapes of various types. Creating a series of landscapes reflecting different seasons, times, and places.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>12</span>
                                                <p>12 Learning the basics of drawing portraits and the human figure. Creating a series of portraits and figures in various styles and techniques.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>13</span>
                                                <p>13 Studying abstract art, its main principles and notable artists. Experiments with color, form, and composition in the context of abstract art. Practice creating abstract works and developing one's own style.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>14</span>
                                                <p>14 Preparing and conducting an exhibition. Creating a portfolio of works. Organizing and conducting a personal exhibition at the art school. Participating in competitions and exhibitions.</p>
                                            </div>
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-sm-none">
                                                <span>View Diploma</span>
                                                <picture>                                                    
                                ...
                                <div class="io-text-wrapper">
                                    <p>The painting course program covers all key aspects of art from beginner to advanced levels, providing students with the opportunity to develop skills in various techniques and styles. The inclusion of theoretical and practical elements, as well as the opportunity to participate in exhibitions and competitions, ensures comprehensive and in-depth training. This program not only fosters technical mastery but also stimulates creative and critical thinking in students, preparing them for advanced levels of artistic creation and self-expression.</p>
                                                    ...
                                                    <div class="io-accordion accordion io-price__accordion" id="ioGiftCourseCheck">
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioGiftCourseCheck-collapseOne" class="accordion-collapse collapse show" aria-labelledby="ioGiftCourseCheck-headingOne">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    <div>
                                                                        <input class="io-radio" type="radio" id="iocheckboxgift11" name="checkbox-group" checked>
                                                    ...
                                                    <div class="io-accordion accordion io-price__accordion" id="ioDemoCourseCheck">
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioDemoCourseCheck-collapseOne" class="accordion-collapse collapse show" aria-labelledby="ioDemoCourseCheck-headingOne">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    <div>
                                                                        <input class="io-checkbox" type="checkbox" id="iocheckbox11" name="checkbox-group" checked>
                                ...
                                <div class="io-accordion accordion" id="faqAccodrion">
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-1">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-1" aria-expanded="false" aria-controls="faqAccordion-collapse-1">
                                                Как записаться на курс живописи онлайн?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-1" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-1" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Записаться на пробный урок живописи и оплатить его можно <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType2">здесь</a>. После этого наш администратор свяжется с вами и согласует день недели и время пробного урока.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2" aria-expanded="false" aria-controls="faqAccordion-collapse-2">
                                                С какого возраста можно учиться детям на курсе живописи онлайн?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-2b" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2b" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Пробный урок рисования стоит <span class="ioArrayToTextElementsDemo">$6</span>. Стоимость пробных уроков на все курсы одинаковая.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-5">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-5" aria-expanded="false" aria-controls="faqAccordion-collapse-5">
                                                Сколько раз в неделю проходят уроки рисования онлайн?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-7" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-7" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Индивидуальный урок рисования длится 45 минут, урок в группе длится 60 минут.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-8" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-8" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Да, у нас есть несколько групп, но не для всех возрастов. Нужно уточнить расписание групп у нашего администратора.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-9">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-9" aria-expanded="false" aria-controls="faqAccordion-collapse-9">
                                                Я никогда не учился ранее рисовать, я могу записаться к вам?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-10">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-10" aria-expanded="false" aria-controls="faqAccordion-collapse-10">
                                                Мой ребенок раньше занимался живописью, вы определите его уровень?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-15">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-15" aria-expanded="false" aria-controls="faqAccordion-collapse-15">
                                                Как нужно подготовиться к урокам живописи?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-15" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-15" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Вам необходимо дома иметь бумагу (любую), простой карандаш и ластик. Материалами можно пользоваться любыми: красками, маркерами, цветными карандашами - что есть дома и что нравится. Если вы будете работать красками, вам понадобится 2 - 3 кисточки разной толщины, палитра для смешивания красок и ёмкость с водой. Также загрузите на ваше устройство приложение Zoom и Google Meet, проверьте работу камеры и звука.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-19" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-19" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    На уроках живописи педагог обязательно уделяет внимание теории и истории искусства.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-20">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-20" aria-expanded="false" aria-controls="faqAccordion-collapse-20">
                                                Есть ли программа курса живописи и можно ли ее посмотреть?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-20" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-20" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Да, программа курса живописи опубликована на сайте на странице курса.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <section class="io-intersection io-course-faq">
                                ...
                                <div class="io-accordion accordion" id="faqAccodrion">
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-1">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-1" aria-expanded="false" aria-controls="faqAccordion-collapse-1">
                                                How to Enroll in an Online Painting Course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-1" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-1" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    You can sign up for a trial painting lesson and pay for it <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType2">here</a>. After that, our administrator will contact you to schedule the day and time for your trial lesson.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2" aria-expanded="false" aria-controls="faqAccordion-collapse-2">
                                                At What Age Can Children Start Learning in the Online Painting Course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-2b" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2b" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    The trial painting lesson costs <span class="ioArrayToTextElementsDemo">$6</span>. The cost is the same for trial lessons across all courses.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-3">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-3" aria-expanded="false" aria-controls="faqAccordion-collapse-3">
                                                What is the Cost of Tuition? Are There Any Discounts?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-3" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-3" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    After the trial lesson, you need to purchase a pass for at least 4 lessons, which costs <span class="ioArrayToTextElements03">$56</span>. You can choose the number of lessons <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType1">here</a>. When purchasing 80 lessons in one payment, discounts from <span class="ioArrayToTextElements62">$120</span> and above apply.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-4" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-4" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    You can select the number of lessons and pay by card on our <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType1">website</a>.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-5">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-5" aria-expanded="false" aria-controls="faqAccordion-collapse-5">
                                                How Often are Online Painting Lessons Held?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-5" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-5" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    We recommend attending classes twice a week.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-6" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-6" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    The lesson schedule is coordinated individually with each student.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-7" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-7" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    An individual drawing lesson lasts 45 minutes, while a group lesson lasts 60 minutes.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-8" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-8" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, we offer several groups, but not for all ages. Please check the group schedules with our administrator.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-9">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-9" aria-expanded="false" aria-controls="faqAccordion-collapse-9">
                                                I've Never Learned to Paint Before, Can I Enroll?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-9" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-9" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, we start teaching from scratch, including for adults.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-10">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-10" aria-expanded="false" aria-controls="faqAccordion-collapse-10">
                                                My Child Has Previously Studied Painting, Will You Assess Their Level?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-10" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-10" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, our educator will determine the skill level and select topics of appropriate complexity.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-11">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-11" aria-expanded="false" aria-controls="faqAccordion-collapse-11">
                                                Can I Take Classes on Weekends?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-11" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-11" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-12">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-12" aria-expanded="false" aria-controls="faqAccordion-collapse-12">
                                                If I Miss a Lesson, Does the Payment Carry Over or Is It Forfeited?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-12" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-12" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    To preserve your payment, you must notify us of your absence at least 24 hours before the lesson starts; otherwise, the teacher will expect you, and you will need to pay for that lesson.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-13" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-13" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, you can pause your lessons for any period; just inform our administrator of your vacation dates.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-14">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-14" aria-expanded="false" aria-controls="faqAccordion-collapse-14">
                                                Will My Child Receive a Diploma at the End of the Course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-14" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-14" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-15">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-15" aria-expanded="false" aria-controls="faqAccordion-collapse-15">
                                                How Should I Prepare for Painting Lessons?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-15" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-15" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    At home, you should have paper (any kind), a regular pencil, and an eraser. You can use any materials you have at home and like: paints, markers, colored pencils. If you will be using paints, you will need 2 - 3 brushes of different thicknesses, a palette for mixing paints, and a water container. Also, download the Zoom and Google Meet apps on your device, and check the camera and sound functionality.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-16" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-16" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    At the Montessori Center, instead of exams with grades, students participate in competitions and exhibitions and win awards.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-18" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-18" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes. It's important, however, that your scheduling preferences align with the teacher's work schedule.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-19">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-19" aria-expanded="false" aria-controls="faqAccordion-collapse-19">
                                                Does the Course Include the Study of Art Theory and History?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-19" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-19" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    During painting lessons, the educator always focuses on art theory and history.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-20">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-20" aria-expanded="false" aria-controls="faqAccordion-collapse-20">
                                                Is There a Painting Course Program Available to View?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-20" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-20" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, the painting course program is published on the course page on our website.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-blog__grid io-blog__grid--three-column">
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                                <picture>
                                                    <source srcset="/wp-content/uploads/2024/05/Paint-01.jpg" type="image/jpeg">
                                                    <img src="/wp-content/uploads/2024/05/Paint-01.jpg" alt="">
                                                </picture>
                                            </div>
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">10 лучших приемов академического рисунка для начинающих</h3>
                                                <p class="io-blog__content-text">Академический рисунок — это основа изобразительного искусства, которая помогает художникам развить навыки наблюдения и точности. Для начинающих важно освоить несколько базовых приёмов, которые помогут заложить надёжный фундамент для дальнейшего развития. Вот десять лучших техник академического рисунка для новичков.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                                <picture>
                                                    <source srcset="/wp-content/uploads/2024/05/Paint-02.jpg" type="image/jpeg">
                                                    <img src="/wp-content/uploads/2024/05/Paint-02.jpg" alt="">
                                                </picture>
                                            </div>
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Как выбрать материалы для академического рисунка: полный гид</h3>
                                                <p class="io-blog__content-text">Выбор материалов для академического рисунка — это первый шаг на пути к освоению этого искусства. Для начинающих художников важно понимать, какие инструменты и материалы лучше всего подходят для развития навыков. В этом гиде мы рассмотрим основные материалы, необходимые для академического рисунка.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                                <picture>
                                                    <source srcset="/wp-content/uploads/2024/05/Paint-03.jpg" type="image/jpeg">
                                                    <img src="/wp-content/uploads/2024/05/Paint-03.jpg" alt="">
                                                </picture>
                                            </div>
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Как овладеть искусством создания аниме-персонажей: пошаговое руководство</h3>
                                                <p class="io-blog__content-text">Создание аниме-персонажей — это увлекательный процесс, который требует не только художественных навыков, но и глубокого понимания истории, психологии и культуры. В этом пошаговом руководстве мы рассмотрим, как начать свой путь в искусстве аниме.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                                <picture>
                                                    <source srcset="/wp-content/uploads/2024/05/Paint-04.jpg" type="image/jpeg">
                                                    <img src="/wp-content/uploads/2024/05/Paint-04.jpg" alt="">
                                                </picture>
                                            </div>
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Как улучшить свои навыки в акварельной живописи через онлайн-курсы</h3>
                                                <p class="io-blog__content-text">Акварельная живопись – это уникальное искусство, создание которого требует тонкости и внимания к деталям. Онлайн-курсы могут стать отличным способом для художников всех уровней улучшить свои навыки в акварели. Вот несколько советов о том, как можно эффективно использовать онлайн-ресурсы для обучения акварельной живописи.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                                <picture>
                                                    <source srcset="/wp-content/uploads/2024/05/Paint-05.jpg" type="image/jpeg">
                                                    <img src="/wp-content/uploads/2024/05/Paint-05.jpg" alt="">
                                                </picture>
                                            </div>
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Использование цифровых инструментов в создании традиционных рисунков</h3>
                                                <p class="io-blog__content-text">В последнее время все большее количество художников старой школы обращаются к цифровым технологиям для улучшения своих традиционных рисунков. Использование цифровых инструментов открывает новые возможности для творчества, позволяя художникам сочетать классические техники с современными технологиями.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                                <picture>
                                                    <source srcset="/wp-content/uploads/2024/05/Paint-06.jpg" type="image/jpeg">
                                                    <img src="/wp-content/uploads/2024/05/Paint-06.jpg" alt="">
                                                </picture>
                                            </div>
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Основы композиции в академическом рисунке</h3>
                                                <p class="io-blog__content-text">Композиция в академическом рисунке — это не просто расположение объектов на листе бумаги; это основа, на которой строится весь художественный образ. Понимание композиционных принципов помогает художникам создавать гармоничные и выразительные работы. Давайте разберем основные аспекты, которые должен знать каждый начинающий художник.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                                <picture>
                                                    <source srcset="/wp-content/uploads/2024/05/Paint-07.jpg" type="image/jpeg">
                                                    <img src="/wp-content/uploads/2024/05/Paint-07.jpg" alt="">
                                                </picture>
                                            </div>
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Портретная живопись для начинающих: основные техники и подходы</h3>
                                                <p class="io-blog__content-text">Портретная живопись — это искусство, требующее не только умения рисовать, но и глубокого понимания человеческой натуры. Для начинающих художников важно освоить основные техники и подходы, чтобы успешно передать не только внешность</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                                <picture>
                                                    <source srcset="/wp-content/uploads/2024/05/Paint-08.jpg" type="image/jpeg">
                                                    <img src="/wp-content/uploads/2024/05/Paint-08.jpg" alt="">
                                                </picture>
                                            </div>
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Секреты мастерства: интервью с профессиональными художниками аниме</h3>
                                                <p class="io-blog__content-text">Аниме – это не просто популярный жанр; это целая культура с уникальными художественными приемами и традициями. Мы пообщались с несколькими известными художниками аниме, чтобы узнать секреты их мастерства и поделиться ими с вами.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                                <picture>
                                                    <source srcset="/wp-content/uploads/2024/05/Paint-09.jpg" type="image/jpeg">
                                                    <img src="/wp-content/uploads/2024/05/Paint-09.jpg" alt="">
                                                </picture>
                                            </div>
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Эволюция скетчинга: от хобби до профессии</h3>
                                                <p class="io-blog__content-text">Скетчинг давно перестал быть простым хобби для аматоров и превратился в полноценную профессию, востребованную во множестве сфер от дизайна до городского планирования. Поговорим о том, как скетчинг эволюционировал от простых зарисовок до профессионального инструмента.</p>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="io-flex-end">
                                ...
                                <section class="io-intersection io-course-blog">
                                    ...
                                    <div class="io-blog__grid io-blog__grid--three-column">
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            ...
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">10 Best Drawing Techniques for Beginners in Academic Drawing</h3>
                                                <p class="io-blog__content-text">Academic drawing forms the foundation of visual arts and aids artists in developing keen observation and precision skills. For beginners, mastering a few basic techniques can establish a solid foundation for further advancement. Here are the top ten academic drawing techniques for novices.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                            ...
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">How to Choose Materials for Academic Drawing: A Complete Guide</h3>
                                                <p class="io-blog__content-text">Selecting the right materials for academic drawing is the first step in mastering this art form. For beginner artists, it's crucial to understand which tools and materials are best suited for developing their skills. This guide will cover the essential materials needed for academic drawing.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                            ...
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">How to Master the Art of Creating Anime Characters: A Step-by-Step Guide</h3>
                                                <p class="io-blog__content-text">Creating anime characters is an exciting process that requires not only artistic skills but also a deep understanding of storytelling, psychology, and culture. This step-by-step guide will explore how to begin your journey in anime art.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                            ...
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">How to Improve Your Watercolor Painting Skills Through Online Courses</h3>
                                                <p class="io-blog__content-text">Watercolor painting is a unique art form that requires finesse and attention to detail. Online courses can be an excellent way for artists of all levels to enhance their watercolor skills. Here are some tips on how to effectively use online resources to learn watercolor painting.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                            ...
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Using Digital Tools in Creating Traditional Artwork</h3>
                                                <p class="io-blog__content-text">Lately, an increasing number of traditional artists are turning to digital technologies to enhance their artwork. The use of digital tools opens up new creative possibilities, allowing artists to blend classic techniques with modern technology.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                            ...
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Fundamentals of Composition in Academic Drawing</h3>
                                                <p class="io-blog__content-text">Composition in academic drawing is not just about placing objects on a piece of paper; it is the foundation on which the entire artistic image is built. Understanding the principles of composition helps artists create harmonious and expressive works. Let's explore the basic aspects that every beginner artist should know.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                            ...
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Portrait Painting for Beginners: Essential Techniques and Approaches</h3>
                                                <p class="io-blog__content-text">Portrait painting is an art that requires not only the ability to draw but also a deep understanding of human nature. For beginner artists, it's important to master basic techniques and approaches to successfully convey not just the appearance but also the character of the person depicted.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                            ...
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">Secrets of Mastery: Interviews with Professional Anime Artists</h3>
                                                <p class="io-blog__content-text">Anime is not just a popular genre; it's an entire culture with unique artistic techniques and traditions. We spoke with several renowned anime artists to uncover the secrets of their craft and share them with you.</p>
                                            </div>
                                        </a>
                                        <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                            <div class="io-blog__img">
                                            ...
                                            <div class="io-blog__content">
                                                <h3 class="io-blog__content-title">The Evolution of Sketching: From Hobby to Profession</h3>
                                                <p class="io-blog__content-text">Sketching has long evolved from a simple hobby for amateurs into a full-fledged profession, sought after in various fields from design to urban planning. Let's discuss how sketching has evolved from simple doodles to a professional tool.</p>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="io-flex-end">
...
<script>
    ...
    var scrollImageRu = '/wp-content/uploads/2023/11/Живопись-Онлайн.svg';
    var scrollImageEn = '/wp-content/uploads/2023/11/Painting-Online.svg';
