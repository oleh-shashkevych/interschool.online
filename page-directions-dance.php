 ...
 * Template Name: Направление - Танцы
 */
...
<style>
        ...
        <div class="io-homepage__hero-container container-xxl io-container-mw">
            <div class="io-homedirection__hero-inner">
                <div class="io-homedirection__hero-left">
                    <div class="io-heading-1 io-homedirection__hero-title w-100">Уроки<br><span class="io-pink-main">Танцев и<br>Йоги</span><br>Онлайн</div>
                </div>
                <div class="io-homedirection__hero-img">
                    <img src="/wp-content/uploads/2024/04/Dance.webp" alt="">
                </div>
            </div>
    ...
    <section class="io-homecourses io-section">
        <div class="container-xxl io-container-mw">
            <h2 class="io-heading-2 text-center" style="margin-bottom: var(--io-size-300);">Танцевальные курсы</h2>
            <div class="io-homecourses__grid">
                <div class="io-popular__item">
                    ...
                    <div class="io-popular__item-button">
                        <a href="<?php echo get_permalink(68); ?>#ceny-i-oplata" class="io-button ioCookieSingleCourseDemo">Пробный урок</a>
                    </div>                        
                </div>  
                <div class="io-popular__item">
                    <div class="io-popular__item-img">
                    ...
                    <div class="io-popular__item-button">
                        <a href="<?php echo get_permalink(66); ?>#ceny-i-oplata" class="io-button ioCookieSingleCourseDemo">Пробный урок</a>
                    </div>                        
                </div>
                <div class="io-popular__item">
                    <div class="io-popular__item-img">
                    ...
                    <div class="io-popular__item-button">
                        <a href="<?php echo get_permalink(70); ?>#ceny-i-oplata" class="io-button ioCookieSingleCourseDemo">Пробный урок</a>
                    </div>                        
                </div>                      
            </div>
        </div>
    ...
    <section class="io-hometeachers io-section">
        <div class="container-xxl io-container-mw">
            <h2 class="io-heading-2 text-center mb-3">Педагоги хореографии и йоги</h2>
