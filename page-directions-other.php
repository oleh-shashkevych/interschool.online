...
<style>
        ...
        <div class="container-xxl io-container-mw">
            <div class="io-homedirection__hero-inner">
                <div class="io-homedirection__hero-left">
                    <div class="io-heading-1 io-homedirection__hero-title io-pink-main w-100">Прочее</div>
                    <div class="io-homedirection__hero-list">
                        <div class="io-homedirection__hero-list-item">
                            <img src="https://images.ctfassets.net/ucy64xj66ql7/78pD7CkZKip4wArjuvxcZV/c559474bdc7cf34f6878a6ebb687b0e7/video.svg">
                            <span>Живые уроки в видеочате</span>
                        </div>
                        <div class="io-homedirection__hero-list-item">
                            <img src="https://images.ctfassets.net/ucy64xj66ql7/71tyX9vz6F3Tue4qwvBMUY/8adb591c34131abcacaf6cd6698ee823/award.svg">
                            <span>Преподаватели мирового класса</span>
                        </div>
                        <div class="io-homedirection__hero-list-item">
                            <img src="https://images.ctfassets.net/ucy64xj66ql7/5GvkT6xl9Vt9mNcvdteoVr/f1d730f166985383f3bea9e60bc5edbb/calendar-check.svg">
                            <span>Гибкий график</span>
                        </div>
                        <div class="io-homedirection__hero-list-item">
                            <img src="https://images.ctfassets.net/ucy64xj66ql7/7kNSeBP9LuYy9GK1jf6kHM/c0d5b364807c64b637bb517dbae8ab7c/shapes.svg">
                            <span>Учим с 5 лет</span>
                        </div>
                    </div>
                </div>
                <div class="io-homedirection__hero-img">
                    <img src="https://interschool.online/wp-content/uploads/2024/03/test.png" alt="">
                </div>
            </div>
        </div>
    </section>

    <svg class="io-homedirection__wave io-section mb-0"><pattern id="curve-6b073590-9b2f-42cb-b5a7-c9b4a550959e" x="0" y="0" width="800" height="100%" patternUnits="userSpaceOnUse"><path fill="currentColor" d="M 0 0 L 0 20 Q 200 0, 400 20 Q 600 40, 800 20 L 800 0 L 0 0"></path><animate attributeName="x" values="0;800" dur="10s" repeatCount="indefinite"></animate></pattern><rect x="0" y="0" width="100%" height="100%" fill="url(#curve-6b073590-9b2f-42cb-b5a7-c9b4a550959e"></rect></svg>

    <section class="io-homecourses io-section">
        <div class="container-xxl io-container-mw">
            <h2 class="io-heading-2 text-center" style="margin-bottom: var(--io-size-300);">Прочие курсы</h2>
            <div class="io-homecourses__grid">
                <div class="io-popular__item">
                    ...
                    <div class="io-popular__item-button">
                        <a href="<?php echo get_permalink(74); ?>#ceny-i-oplata" class="io-button ioCookieSingleCourseDemo">Пробный урок</a>
                    </div>                        
                </div>
            </div>
        </div>
    ...
    <section class="io-hometeachers io-section">
        <div class="container-xxl io-container-mw">
            <h2 class="io-heading-2 text-center mb-3">Педагоги курсов</h2>
    ...
    <section class="io-section io-dirircle">
        <div class="container-xxl io-container-mw">
            ...
            <div class="io-dirircle__list">
                <a href="<?php echo get_permalink(52); ?>" class="io-dirircle__element">
                    <div class="io-dirircle__element-img">
                        <img src="/wp-content/uploads/2024/04/palette-1.svg" alt="">
                    </div>
                    <h3 class="io-dirircle__element-title">Изобразительное искусство</h3>
                </a>
                <a href="<?php echo get_permalink(24); ?>" class="io-dirircle__element">
                    <div class="io-dirircle__element-img">
                        <img src="/wp-content/uploads/2024/04/musical-note-1.svg" alt="">                        
                    </div>
                    <h3 class="io-dirircle__element-title">Музыкальное искусство</h3>
                </a>
                <a href="<?php echo get_permalink(76); ?>" class="io-dirircle__element">
                    <div class="io-dirircle__element-img">
                        <img src="/wp-content/uploads/2024/04/translator-1.svg" alt="">                        
                    </div>
                    <h3 class="io-dirircle__element-title">Иностранные языки</h3>
                </a>
                <a href="<?php echo get_permalink(90); ?>" class="io-dirircle__element">
                    <div class="io-dirircle__element-img">
                        <img src="/wp-content/uploads/2024/04/stationery-1.svg" alt="">                        
                    </div>
                    <h3 class="io-dirircle__element-title">Средняя школа</h3>
                </a>
                <a href="<?php echo get_permalink(64); ?>" class="io-dirircle__element">
                    <div class="io-dirircle__element-img">
                        <img src="/wp-content/uploads/2024/04/dancing-1.svg" alt="">                        
                    </div>
                    <h3 class="io-dirircle__element-title">Хореография и танцы</h3>
                </a>
            </div>
        </div>
    </section>
