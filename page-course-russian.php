                    ...
                    <div class="io-sidebar__inner">
                        <section class="io-course-passport">
                            ...
                            <div class="io-course-passport__header">
                                <span class="io-course-passport__header-title"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Курс русского языка'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Russian course'; } ?></span>
                        ...
                        <div class="tab-pane fade show active" id="<?php echo $ioTab1; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab1; ?>-tab">
                            <div>
                                <section class="io-intersection io-course-hero">
                                    <h1 class="io-heading-1 io-course-hero__heading"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Уроки<br><span class="io-pink-main">Русского<br>Языка</span><br>Oнлайн'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Online<br><span class="io-pink-main">Russian</span><br>Lessons'; } ?></h1>
                                    ...
                                    <div class="io-course-hero__rating io-rating">
                                        ...
                                        <div class="io-rating__bottom">
                                            <div class="io-rating__bottom-left">
                                                ...
                                                <span>+78 <?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'отзывов'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'reviews'; } ?></span>
                                            </div>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioGiftCourseCheck-collapseThree" class="accordion-collapse collapse show" aria-labelledby="ioGiftCourseCheck-headingThree">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-radio" type="radio" id="iocheckboxgift32" name="checkbox-group" checked>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioDemoCourseCheck-collapseThree" class="accordion-collapse collapse show" aria-labelledby="ioDemoCourseCheck-headingThree">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-checkbox" type="checkbox" id="iocheckbox32" name="checkbox-group" checked>
                                ...
                                <div class="io-blog__grid io-blog__grid--three-column">
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                            <picture>                                
                                                <source srcset="/wp-content/uploads/2024/05/russian-01.jpg" type="image/jpeg">
                                                <img src="/wp-content/uploads/2024/05/russian-01.jpg" alt="">
                                            </picture>
                                        </div>
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Эффективные методы изучения русского языка онлайн</h3>
                                            <p class="io-blog__content-text">Изучение русского языка онлайн становится все более популярным благодаря удобству и доступности современных технологий. В этой статье мы рассмотрим</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                            <picture>                                
                                                <source srcset="/wp-content/uploads/2024/05/russian-02.jpg" type="image/jpeg">
                                                <img src="/wp-content/uploads/2024/05/russian-02.jpg" alt="">
                                            </picture>
                                        </div>
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Разговорный русский: как улучшить свои навыки общения онлайн</h3>
                                            <p class="io-blog__content-text">Изучение русского языка - это не только освоение грамматики и расширение словарного запаса, но и развитие навыков общения. Важно научиться свободно</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                            <picture>                                
                                                <source srcset="/wp-content/uploads/2024/05/russian-03.jpg" type="image/jpeg">
                                                <img src="/wp-content/uploads/2024/05/russian-03.jpg" alt="">
                                            </picture>
                                        </div>
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Как научиться писать на русском языке красиво и грамотно</h3>
                                            <p class="io-blog__content-text">Умение писать на русском языке красиво и грамотно – важный навык, который открывает множество возможностей для общения и профессионального роста</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                            <picture>                                
                                                <source srcset="/wp-content/uploads/2024/05/russian-04.jpg" type="image/jpeg">
                                                <img src="/wp-content/uploads/2024/05/russian-04.jpg" alt="">
                                            </picture>
                                        </div>
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Влияние современных технологий на изучение русского языка</h3>
                                            <p class="io-blog__content-text">Современные технологии существенно изменили способы изучения языков, и русский язык не стал исключением. Они открыли новые возможности для учащихся</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                            <picture>                                
                                                <source srcset="/wp-content/uploads/2024/05/russian-05.jpg" type="image/jpeg">
                                                <img src="/wp-content/uploads/2024/05/russian-05.jpg" alt="">
                                            </picture>
                                        </div>
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Как мотивировать себя учить русский язык онлайн: личный опыт и советы</h3>
                                            <p class="io-blog__content-text">Изучение русского языка онлайн может быть увлекательным и полезным, но иногда найти мотивацию для регулярных занятий бывает сложно. В этой статье я поделюсь</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                            <picture>                                
                                                <source srcset="/wp-content/uploads/2024/05/russian-06.jpg" type="image/jpeg">
                                                <img src="/wp-content/uploads/2024/05/russian-06.jpg" alt="">
                                            </picture>
                                        </div>
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Топ-5 ошибок при изучении русского языка и как их избежать</h3>
                                            <p class="io-blog__content-text">Изучение русского языка – увлекательный, но в то же время сложный процесс. Многие учащиеся сталкиваются с определёнными трудностями и часто совершают типичные</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                            <picture>                                
                                                <source srcset="/wp-content/uploads/2024/05/russian-07.jpg" type="image/jpeg">
                                                <img src="/wp-content/uploads/2024/05/russian-07.jpg" alt="">
                                            </picture>
                                        </div>
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Использование искусственного интеллекта в изучении русского языка: современные решения</h3>
                                            <p class="io-blog__content-text">Искусственный интеллект (ИИ) в последние годы становится неотъемлемой частью нашей жизни, и его влияние на процесс обучения языкам, включая русский, сложно</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                            <picture>                                
                                                <source srcset="/wp-content/uploads/2024/05/russian-08.jpg" type="image/jpeg">
                                                <img src="/wp-content/uploads/2024/05/russian-08.jpg" alt="">
                                            </picture>
                                        </div>
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Преимущества погружения в языковую среду онлайн</h3>
                                            <p class="io-blog__content-text">Современные технологии значительно расширили возможности для изучения иностранных языков. Одним из наиболее эффективных методов является погружение </p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                            <picture>                                
                                                <source srcset="/wp-content/uploads/2024/05/russian-09.jpg" type="image/jpeg">
                                                <img src="/wp-content/uploads/2024/05/russian-09.jpg" alt="">
                                            </picture>
                                        </div>
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Русский язык для детей: эффективные онлайн-методики</h3>
                                            <p class="io-blog__content-text">Обучение детей русскому языку требует особого подхода, так как важна не только передача знаний, но и поддержание интереса к предмету</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="io-flex-end">
                            ...
                            <section class="io-intersection io-course-blog">
                                ...
                                <div class="io-blog__grid io-blog__grid--three-column">
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        ...
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Effective Methods for Learning Russian Online</h3>
                                            <p class="io-blog__content-text">Learning Russian online is becoming increasingly popular due to the convenience and accessibility of modern technology. In this article, we will explore effective methods to help</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                        ...
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Conversational Russian: How to Improve Your Speaking Skills Online</h3>
                                            <p class="io-blog__content-text">Learning Russian involves not only mastering grammar and expanding your vocabulary but also developing communication skills. It’s crucial to learn how to speak Russian fluently to</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                        ...
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">How to Learn to Write Beautifully and Correctly in Russian</h3>
                                            <p class="io-blog__content-text">The ability to write beautifully and correctly in Russian is an important skill that opens up many opportunities for communication and professional growth. This art can be mastered</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                        ...
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">The Impact of Modern Technology on Learning Russian</h3>
                                            <p class="io-blog__content-text">Modern technology has significantly changed the ways we learn languages, and Russian is no exception. These advancements have opened new opportunities for learners, providing</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                        ...
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">How to Motivate Yourself to Learn Russian Online: Personal Experience and Tips</h3>
                                            <p class="io-blog__content-text">Learning Russian online can be both exciting and rewarding, but sometimes finding the motivation for regular study sessions can be challenging. In this article, I will share my</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                        ...
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Top 5 Mistakes When Learning Russian and How to Avoid Them</h3>
                                            <p class="io-blog__content-text">Learning Russian is a fascinating yet challenging process. Many learners encounter certain difficulties and often make common mistakes that hinder their progress. In this article, we will </p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                        ...
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">The Use of Artificial Intelligence in Learning Russian: Modern Solutions</h3>
                                            <p class="io-blog__content-text">In recent years, artificial intelligence (AI) has become an integral part of our lives, and its impact on the process of language learning, including Russian, cannot be overstated</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                        ...
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Advantages of Immersion in an Online Language Environment</h3>
                                            <p class="io-blog__content-text">Modern technologies have significantly expanded the opportunities for learning foreign languages. One of the most effective methods is immersion in an online language</p>
                                        </div>
                                    </a>
                                    <a href="<?php echo get_permalink(123); ?>" class="io-blog__item">
                                        <div class="io-blog__img">                            
                                        ...
                                        <div class="io-blog__content">
                                            <h3 class="io-blog__content-title">Russian Language for Children: Effective Online Methods</h3>
                                            <p class="io-blog__content-text">Teaching children the Russian language requires a special approach, as it is important not only to impart knowledge but also to maintain their interest in the subject</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="io-flex-end">
...
<script>
    ...
    var scrollImageRu = '/wp-content/uploads/2023/11/Русский-Онлайн.svg';
    var scrollImageEn = '/wp-content/uploads/2023/11/Russian-Online.svg';
