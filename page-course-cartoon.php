    ...
    if (ICL_LANGUAGE_CODE === 'ru') {
        ...
        $contentTab3 = '
            <section class="io-intersection io-course-lectors">
                <h2 class="io-heading-2 io-course-lectors__heading">Преподаватели мультипликации</h2>
                <div class="io-course-lectors__text-wrapper io-text-wrapper">
                    <div class="io-check io-check--start">
                        <span>Наши преподаватели мультипликации обладают высшим образованием в области анимации и мультимедиа, а также обширным опытом работы как в преподавании, так и в анимационной индустрии.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Они умело сочетают теоретические знания с практическими навыками, что позволяет студентам глубоко погружаться в мир мультипликации. Преподаватели нашей школы регулярно участвуют в анимационных фестивалях и конференциях, что позволяет им постоянно совершенствовать свои навыки и расширять профессиональные горизонты.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Наша программа направлена не только на обучение основным техникам создания анимации, но и на развитие креативности студентов, помогая им найти собственный стиль и реализовать себя в анимационном искусстве. Мы уделяем особое внимание индивидуальному подходу к каждому ученику, что способствует их всестороннему развитию и успешной реализации творческого потенциала.</span>
                    </div>
                </div>
        ...
        $contentTab3 = '
            <section class="io-intersection io-course-lectors">
                <h2 class="io-heading-2 io-course-lectors__heading">Animation teachers</h2>
                <div class="io-course-lectors__text-wrapper io-text-wrapper">
                    <div class="io-check io-check--start">
                        <span>Our animation teachers hold advanced degrees in animation and multimedia and possess extensive experience in both teaching and the animation industry.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>They skillfully combine theoretical knowledge with practical skills, allowing students to deeply immerse themselves in the world of animation. Our school\'s teachers regularly participate in animation festivals and conferences, continually honing their skills and expanding their professional horizons.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Our program is designed not only to teach the basic techniques of animation creation but also to foster students\' creativity, helping them find their own style and express themselves in the art of animation. We place special emphasis on an individualized approach to each student, which supports their comprehensive development and successful creative realization.</span>
                    </div>
                </div>
                <div class="io-course-lectors__item io-block">
                    <div class="io-course-lectors__item-header">
                    ...
                    <div class="io-sidebar__inner">
                        <section class="io-course-passport">
                            ...
                            <div class="io-course-passport__header">
                                <span class="io-course-passport__header-title"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Курс мультипликации'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Animation course'; } ?></span>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="<?php echo $ioTab1; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab1; ?>-tab">
                            <div>
                                <section class="io-intersection io-course-hero">
                                    <h1 class="io-heading-1 io-course-hero__heading"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Уроки<br><span class="io-pink-main">Мультипликации</span><br>Oнлайн'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Online<br><span class="io-pink-main">Animation</span><br>Lessons'; } ?></h1>
                                    ...
                                    <div class="io-course-hero__rating io-rating">
                                        ...
                                        <div class="io-rating__bottom">
                                            <div class="io-rating__bottom-left">
                                                ...
                                                <span>+192 <?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'отзыва'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'reviews'; } ?></span>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="<?php echo $ioTab2; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab2; ?>-tab">
                            ...
                            <section class="io-intersection io-course-lesson">
                                <h2 class="io-heading-2 io-course-lesson__heading">Как проходят уроки мультипликации</h2>
                                <div class="io-video">
                                ...
                                <div class="io-steps__wrapper">
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Оборудование:</span> для онлайн-уроков мультипликации (анимации) вам потребуется обычный планшет на операционной системе Android или iOS с соответствующим стилусом.</p>
                                    ...
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            ...
                                            <p><span class="io-fw-semibold">Материалы для урока:</span> Программное обеспечение: установите программу для создания анимации: для планшетов на iOS вам нужно установить программу Procreate. Аксессуары: подготовьте графический планшет и подключите его к компьютеру или ноутбуку. Для обычного планшета убедитесь, что он заряжен.</p>
                                            <p><span class="io-fw-semibold">Настройка рабочего места:</span> Размещение устройства: расположите ваш компьютер или ноутбук так, чтобы камера и микрофон были направлены на вас. Это обеспечит хорошее взаимодействие с преподавателем. Тестирование техники: За 5-10 минут до начала занятия войдите в приложение для видеоконференций по полученной ссылке и проверьте работоспособность вашей камеры, микрофона и интернет-соединения.</p>
                                            <p>Эти шаги помогут вам максимально эффективно подготовиться к занятию по анимации.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Инструкции и обратная связь:</span> Ваш преподаватель по анимации предоставит детальные указания по применению программ для анимации и ключевых инструментов. Вы получите конструктивную обратную связь, которая поможет вам улучшить как технические умения, так и креативный подход.</p>
                                            <p><span class="io-fw-semibold">Задавайте вопросы:</span> если у вас возникнут сложности или вопросы по особенностям работы в анимационных программах, смело спрашивайте у преподавателя. Он готов помочь вам разобраться в любых аспектах создания анимации.</p>
                                            <p><span class="io-fw-semibold">Практика:</span> большую часть урока вы будете практиковаться в создании анимационных проектов. Преподаватель будет наблюдать за вашими успехами, давать советы и указывать на возможные способы совершенствования ваших навыков.</p>
                                            <p><span class="io-fw-semibold">Демонстрация преподавателем:</span> преподаватель будет показывать техники анимации на примерах, делиться профессиональными хитростями и объяснять, как достичь наилучших результатов в создании анимационных сцен.</p>
                                            <p><span class="io-fw-semibold">Завершение урока:</span> по окончании занятия вы обсудите с преподавателем пройденные методы, получите задания для домашней практики и совместно спланируете следующие шаги вашего обучения.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p>Материалы для самостоятельной работы: преподаватель предоставит вам рекомендации по применению анимационных инструментов, примеры выдающихся анимационных работ и дополнительные материалы для глубокого изучения анимации.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps io-steps--last">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p class="io-purple-main io-fs-18 io-fw-semibold">Мы убеждены, что онлайн-уроки анимации обеспечат вам комфорт и эффективность в освоении необходимых навыков. Ваше образование будет захватывающим и результативным!</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            <?php } elseif (ICL_LANGUAGE_CODE === 'en') { ?>
                            <section class="io-intersection io-course-lesson">
                                <h2 class="io-heading-2 io-course-lesson__heading">How Animation Lessons are Conducted</h2>
                                <div class="io-video">
                                ...
                                <div class="io-steps__wrapper">
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Equipment:</span> For online animation lessons, you will need a standard tablet running on Android or iOS with a suitable stylus.</p>
                                            ...
                                            <p><span class="io-fw-semibold">Video Conferencing Platform:</span> Lessons are conducted via platforms like Zoom or Google Meet. Install and check the software in advance.</p>
                                            <p><span class="io-fw-semibold">Sound:</span> Using headphones with a microphone will enhance audibility and eliminate background noises during the lesson.</p>
                                            <p><span class="io-fw-semibold">Lighting and Workspace:</span> Ensure good lighting in your workspace to work comfortably without glare.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">2</div>
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Lesson Link:</span> The link to the online lesson will be sent to you well in advance via email or your preferred messenger. Ensure you have received it a day before the lesson starts.</p>
                                            <p><span class="io-fw-semibold">Materials for the Lesson:</span> Software: Install animation creation software; for iOS tablets, Procreate is required. Accessories: Prepare your graphic tablet and connect it to your computer or laptop. Make sure a standard tablet is charged.</p>
                                            <p><span class="io-fw-semibold">Workspace Setup:</span> Ensure your desk is comfortable and not cluttered, creating optimal conditions for creativity.</p>
                                            <p><span class="io-fw-semibold">Device Placement:</span> Position your computer or laptop so that the camera and microphone are facing you, ensuring good interaction with the teacher. Tech Check: Enter the video conferencing application using the provided link 5-10 minutes before the lesson starts and check the functionality of your camera, microphone, and internet connection.</p>
                                            <p>These steps will help you prepare effectively for your animation class.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">3</div>
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Instructions and Feedback:</span> Your animation teacher will provide detailed instructions on using animation software and key tools. You will receive constructive feedback that will help enhance both your technical skills and creative approach.</p>
                                            <p><span class="io-fw-semibold">Ask Questions:</span> If you encounter difficulties or have questions about working with animation software, feel free to ask your teacher. They are ready to assist you with any aspects of animation creation.</p>
                                            <p><span class="io-fw-semibold">Practice:</span> Most of the lesson will be dedicated to hands-on projects. Your teacher will monitor your progress, offer tips, and suggest ways to improve your skills.</p>
                                            <p><span class="io-fw-semibold">Teacher Demonstrations:</span> The teacher will demonstrate animation techniques, share professional tips, and explain how to achieve the best results in creating animation scenes.</p>
                                            <p><span class="io-fw-semibold">Lesson Conclusion:</span> At the end of the lesson, you will discuss the techniques learned, receive assignments for home practice, and plan the next steps of your learning together.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">4</div>
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p>Materials for Independent Study: The teacher will provide you with recommendations for using animation tools, examples of successful animation projects, and additional resources for in-depth study of animation.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps io-steps--last">
                                        <div class="io-steps__empty">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p class="io-purple-main io-fs-18 io-fw-semibold">We are confident that online animation lessons will provide you with comfort and effectiveness in acquiring the necessary skills. Your education will be exciting and productive!</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioGiftCourseCheck-collapseOne" class="accordion-collapse collapse show" aria-labelledby="ioGiftCourseCheck-headingOne">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-radio" type="radio" id="iocheckboxgift15" name="checkbox-group" checked>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioDemoCourseCheck-collapseOne" class="accordion-collapse collapse show" aria-labelledby="ioDemoCourseCheck-headingOne">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-checkbox" type="checkbox" id="iocheckbox15" name="checkbox-group" checked>
                                ...
                                <div class="io-accordion accordion" id="faqAccodrion">
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-1">
                                            ...
                                            Как записаться на курс мультипликации онлайн? 
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-1" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-1" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                ...
                                                Записаться на пробный урок мультипликации и оплатить его можно <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType2">здесь</a>. После этого наш администратор свяжется с вами и согласует день недели и время пробного урока.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2">
                                            ...
                                            С какого возраста можно учиться детям на курсе мультипликации онлайн?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                На курс мультипликации мы приглашаем детей от 7 лет.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2bb">
                                            ...
                                            Как нужно подготовиться к урокам мультипликации?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2bb" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2bb" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                Вам необходимо дома иметь планшет IPad и стилус (специальный карандаш для рисования на планшете). Также загрузите на ваше устройство приложение Zoom и Google Meet, проверьте работу камеры и звука. Кроме этого понадобится программное обеспечение, в котором будет работать студент: для планшетов на IOS - программа Procreate. Загрузите и установите нужную программу заранее до урока.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-2b" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2b" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Пробный урок мультипликации стоит <span class="ioArrayToTextElementsDemo">$6</span>. Стоимость пробных уроков на все курсы одинаковая.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    Сколько раз в неделю проходят уроки мультипликации онлайн? 
                                    Мы рекомендуем заниматься 2 раза в неделю, но вы можете сами регулировать частоту уроков, в зависимости от вашего расписания. 
                                    Как составляется расписание уроков?
                                    Расписание уроков согласовывает наш администратор с каждым студентом индивидуально.
                                    Сколько длится урок? 
                                    Индивидуальный урок мультипликации длится 45 минут.
                                    Можно ли учиться в группе?
                                    Нет, уроки мультипликации проходят только индивидуально.
                                    Я никогда не учился ранее, я могу записаться к вам? 
                                    Да, мы начинаем обучение с нуля для взрослых в том числе.
                                    Мой ребенок раньше занимался мультипликацией, вы определите его умения?
                                    Да, наш педагог определит уровень навыков и знаний и подберет темы соответствующего уровня сложности. 
                                    ...
                                    Чтобы сохранить оплату, вам необходимо предупредить нас об отсутствии на уроке минимум за 24 часа до его начала, в ином случае учитель будет Вас ждать и урок будет считаться состоявшимся.
                                    ...
                                    Будет ли мой ребенок сдавать какие-либо экзамены? 
                                    В Монтессори центре вместо экзаменов с оценками студенты принимают участие в конкурсах и показывают свои достижения через соревнования с другими студентами. 
                                    ...
                                    Есть ли программа курса мультипликации и можно ли ее посмотреть?
                                    Да, программа курса мультипликации опубликована на сайте на странице курса.
                                    <div class="io-accordion__item accordion-item">
                            ...
                            <section class="io-intersection io-course-faq">
                                ...
                                <div class="io-accordion accordion" id="faqAccodrion">
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-1">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-1" aria-expanded="false" aria-controls="faqAccordion-collapse-1">
                                            How to Enroll in an Online Animation Course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-1" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-1" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                You can sign up for a trial animation lesson and pay for it <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType2">here</a>. Afterward, our administrator will contact you to arrange the day of the week and time for the trial lesson.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2" aria-expanded="false" aria-controls="faqAccordion-collapse-2">
                                            What is the minimum age for children to attend the online animation course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                We invite children from the age of 7 to join the animation course.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2bb">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2bb" aria-expanded="false" aria-controls="faqAccordion-collapse-2bb">
                                            How should I prepare for the animation lessons?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2bb" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2bb" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                You will need to have an iPad and a stylus (special pencil for drawing on a tablet) at home. Also, download the Zoom and Google Meet applications on your device, check your camera and sound. Additionally, you will need the Procreate software for iOS tablets. Please download and install the necessary software before the lesson.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-2b" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2b" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                The trial animation lesson costs <span class="ioArrayToTextElementsDemo">$6</span>. The cost for trial lessons is the same across all courses.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-3" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-3" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                After the trial lesson, you must purchase a pass for at least 4 lessons, which costs <span class="ioArrayToTextElements03">$56</span>. You can select the number of lessons you want to buy <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType1">here</a>. If you purchase 80 or more lessons in a single payment, you'll receive a discount of <span class="ioArrayToTextElements62">$120</span>.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    How often are the online animation lessons held?
                                    ...
                                    Our administrator individually coordinates the lesson schedule with each student.
                                    How long does a lesson last?
                                    An individual animation lesson lasts 45 minutes.
                                    Can I learn in a group?
                                    No, animation lessons are only conducted individually.
                                    I have never studied before; can I enroll?
                                    Yes, we start from scratch, including for adults.
                                    My child has previously engaged in animation; will you assess their skills?
                                    Yes, our teacher will determine the level of skills and knowledge and select topics appropriate to that level of difficulty.
                                    ...
                                    To retain your payment, you must notify us at least 24 hours before the lesson starts. Otherwise, the teacher will expect you and the lesson will be considered as held.
                                    ...
                                    Will my child have to take any exams?
                                    At the Montessori center, instead of exams with grades, students participate in contests and demonstrate their achievements through competitions with other students.
                                    ...
                                    Is there a program for the animation course available to view?
                                    Yes, the animation course program is published on our website on the course page.
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-5">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-5" aria-expanded="false" aria-controls="faqAccordion-collapse-5">
                                                How often are the online animation lessons held?
...
<script>
    ...
    var scrollImageRu = '/wp-content/uploads/2023/11/Мультипликация-Онлайн.svg';
    var scrollImageEn = '/wp-content/uploads/2023/11/Animation-Online.svg';
