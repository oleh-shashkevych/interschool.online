    ...
    if (ICL_LANGUAGE_CODE === 'ru') {
        ...
        $contentTab3 = '
            <section class="io-intersection io-course-lectors">
                <h2 class="io-heading-2 io-course-lectors__heading">Преподаватели бас-гитары</h2>
                <div class="io-course-lectors__text-wrapper io-text-wrapper">
                    <div class="io-check io-check--start">
                        <span>Каждый преподаватель бас-гитары в Монтессори центре имеет высшее музыкальное образование по специальности "Бас-гитара".</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Наши педагоги обучают не только искусству игры на бас-гитаре, но и на электрогитаре, классической гитаре и укулеле.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Команда имеет значительный опыт проведения онлайн-занятий по бас-гитаре для учащихся всех возрастных категорий, уделяя индивидуальное внимание каждому студенту в процессе обучения.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Преподаватели бас-гитары в нашем учебном заведении являются активными исполнителями. Они участвуют в различных музыкальных мероприятиях и концертах, непрерывно совершенствуя свое исполнительское мастерство.</span>
                    </div>
        ...
        $contentTab3 = '
            <section class="io-intersection io-course-lectors">
                <h2 class="io-heading-2 io-course-lectors__heading">Bass Guitar Teachers</h2>
                <div class="io-course-lectors__text-wrapper io-text-wrapper">
                    <div class="io-check io-check--start">
                        <span>Every bass guitar teacher at the Montessori center holds an advanced musical education in "Bass Guitar."</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Our teachers not only instruct in the art of playing the bass guitar but also in electric guitar, classical guitar, and ukulele.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>The team boasts significant experience in delivering online bass guitar lessons to students across all age brackets, paying close attention to each student\'s learning journey.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Bass guitar teachers at our institution are also active performers. They engage in various musical events and concerts, continually honing their performance skills.</span>
                    </div>
                </div>
                <div class="io-course-lectors__item io-block">
                    <div class="io-course-lectors__item-header">
                    ...
                    <div class="io-sidebar__inner">
                        <section class="io-course-passport">
                            ...
                            <div class="io-course-passport__header">
                                <span class="io-course-passport__header-title"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Курс бас-гитары'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Bass guitar course'; } ?></span>
                                ...
                                <div class="io-icon-with-desc">
                                    ...
                                    <div class="io-icon-with-desc__info">
                                        ...
                                        <div class="io-icon-with-desc__info-text">
                                            <?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'от 10 лет'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'from 10 years'; } ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="io-icon-with-desc">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="<?php echo $ioTab1; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab1; ?>-tab">
                            <div>
                                <section class="io-intersection io-course-hero">
                                    <h1 class="io-heading-1 io-course-hero__heading"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Уроки<br><span class="io-purple-main">Бас-гитары</span><br>Oнлайн'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Online<br><span class="io-purple-main">Bass Guitar</span><br>Lessons'; } ?></h1>
                                    <p class="io-course-hero__text"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'На курсе бас-гитары вы освоите технику грува, овладеете навыками ритмичной игры, научитесь играть с барабанщиками и другими музыкантами, а также уверенно выступать на сцене!'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'In this bass guitar course, you will master groove techniques, develop rhythmic playing skills, learn to collaborate with drummers and other musicians, and confidently perform on stage!'; } ?></p>
                                </section>
                                    ...
                                    <div class="io-course-hero__rating io-rating">
                                        ...
                                        <div class="io-rating__bottom">
                                            <div class="io-rating__bottom-left">
                                                ...
                                                <span>+122 <?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'отзыва'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'reviews'; } ?></span>
                                            </div>
                                                ...
                                                <div class="io-accordion__body accordion-body io-grid-gap-150 io-mobile-grid-gap-100">
                                                    <div class="io-icon-with-text">
                                                        ...
                                                        <div class="io-icon-with-text__content">
                                                            <p><strong>Бас-гитара и усилитель:</strong> вам понадобится бас-гитара и усилитель для онлайн-уроков. Необходим также кабель для соединения бас-гитары с усилителем.</p>
                                                        </div>
                                                    </div>
                                                    <div class="io-icon-with-text">
                                                        <div class="io-icon-with-text__img">
                                                        ...
                                                        <div class="io-icon-with-text__content">
                                                            <p><strong>Гаджет с камерой и микрофоном:</strong> необходимы для участия в онлайн-уроках. Они позволят вашему преподавателю видеть и слышать вас во время занятий.</p>
                                                        </div>
                                                    </div>
                                                    <div class="io-icon-with-text">
                                                        <div class="io-icon-with-text__img">
                                                        ...
                                                        <div class="io-icon-with-text__content">
                                                            <p><strong>Наушники:</strong> использование качественных наушников поможет лучше слышать звук вашей бас-гитары и минимизировать внешние помехи во время урока.</p>
                                                        </div>
                                                    </div>
                                                    <div class="io-icon-with-text">
                                                        <div class="io-icon-with-text__img">
                                                        ...
                                                        <div class="io-icon-with-text__content">
                                                            <p><strong>Ноты и учебные материалы:</strong> мы предоставим вам необходимые ноты и материалы перед уроками. Вы можете распечатать их или открыть на экране вашего устройства для удобства использования во время занятий.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="io-accordion__item accordion-item">
                                            <h2 class="io-accordion__header accordion-header" id="courseAccordion-headingTwoB">
                                                <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#courseAccordion-collapseTwoB" aria-expanded="false" aria-controls="courseAccordion-collapseTwoB">
                                                    Как правильно выбрать бас-гитару и усилитель
                                                </button>
                                            </h2>
                                            <div id="courseAccordion-collapseTwoB" class="accordion-collapse collapse" aria-labelledby="courseAccordion-headingTwoB" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body">
                                                    <div class="io-content">
                                                        <strong>При выборе бас-гитары важно разобраться в различных типах и особенностях, чтобы подобрать инструмент, который наилучшим образом отвечает вашим музыкальным предпочтениям и целям. Вот основные типы бас-гитар, которые стоит рассмотреть новичку:</strong>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Инвестируйте в качество:</strong> не экономьте на покупке бас-гитары. Хороший инструмент не только обеспечит отличное звучание, но и сделает процесс обучения более комфортным и приятным.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Выбирайте бас с ладами:</strong> для начала выберите инструмент с ладами. Безладовые басы могут быть интересны опытным музыкантам, но для начинающих они представляют дополнительные сложности.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Стандартная мензура:</strong> при выборе баса рекомендуется остановиться на стандартной мензуре 34 дюйма. Это универсальный вариант, подходящий для большинства музыкантов. Басы с укороченной мензурой стоит рассматривать для детей и людей невысокого роста.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Четырехструнная модель:</strong> начните с четырехструнной бас-гитары. Это оптимальный выбор для освоения основ. Мода и советы могут побудить вас выбрать бас с большим количеством струн, но начинать стоит с базового инструмента.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Простота настроек:</strong> выбирайте бас с понятным и легким в управлении эквалайзером. Сложные настройки могут быть излишними на начальном этапе.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Личные предпочтения:</strong> покупайте инструмент, который вам нравится как внешне, так и по звучанию. Эстетическая привлекательность может существенно повысить вашу мотивацию.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Проверяйте и выбирайте самостоятельно:</strong> всегда пробуйте инструмент перед покупкой. Играть на басу будете вы, поэтому важно, чтобы он был удобен именно вам.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Разумный выбор бренда:</strong> если ваш бюджет ограничен, рассмотрите менее известные марки. Зачастую они предлагают хорошее качество за разумную цену и вы избежите риска приобретения подделки. Известные бренды, такие как Fender или Gibson также можно найти по невысокой стоимости.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Precision Bass (P-Bass):</strong> один из самых классических и популярных видов бас-гитар. Отличается мощным и плотным звучанием, подходит для множества стилей, особенно для рок-музыки и блюза.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Jazz Bass (J-Bass):</strong> известен своим более ярким и чистым звуком по сравнению с P-Bass. Широкий диапазон звуков делает его популярным выбором среди джазовых и фанк-музыкантов.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Semi-Hollow (полуакустическая бас-гитара):</strong> эти басы сочетают в себе элементы акустических и электрических басов, обеспечивая теплое резонансное звучание. Отлично подходят для джаза и блюза.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Акустический бас с пьезодатчиками:</strong> этот тип баса может использоваться как акустический инструмент, так и подключаться к усилителю. Идеален для небольших мест или ансамблей.</div></div>
                                                    </div>
                                                    <div class="io-content">
                                                        <strong>Выбор усилителя (комбика) для бас-гитары:</strong>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Мощность и размер:</strong> мини-комбики подходят для домашних условий, но для больших площадок понадобится что-то мощнее.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Совместимость:</strong> усилители для электрогитары не подходят, так как они не адаптированы для воспроизведения низких частот баса.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Проба в магазине:</strong> всегда пробуйте усилитель с вашим басом в магазине, чтобы убедиться в качестве звука.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Бонус-совет:</strong> дайте вашему инструменту уникальное имя. Это добавит вам уверенности и сделает ваш музыкальный путь более личным и запоминающимся. Так делали многие легендарные бас-гитаристы.</div></div>
                                                    </div>
                                                    <div class="io-content">
                                                        Принимая все эти компоненты во внимание, вы будете готовы сделать осознанный выбор и начать своё путешествие в мир музыки со своей первой бас-гитарой.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="io-course-accordion__diploma">
                                                        <a href="#" target="_blank" class="io-lightbox">
                                                            ...
                                                            <picture>
                                                                ...
                                                                <source srcset="/wp-content/uploads/2024/04/Screenshot-2024-04-22-155651.png" type="image/jpeg">
                                                                <img src="/wp-content/uploads/2024/04/Screenshot-2024-04-22-155651.png" alt="">
                                                            </picture>
                                                        </a>
                                                        <a href="#" target="_blank" class="io-lightbox">
                                                            ...
                                                            <picture>
                                                                ...
                                                                <source srcset="/wp-content/uploads/2024/04/Screenshot-2024-04-22-155703.png" type="image/jpeg">
                                                                <img src="/wp-content/uploads/2024/04/Screenshot-2024-04-22-155703.png" alt="">
                                                            </picture>
                                                        </a>
                                                        <a href="#" target="_blank" class="io-lightbox">
                                                            ...
                                                            <picture>
                                                                ...
                                                                <source srcset="/wp-content/uploads/2024/04/Screenshot-2024-04-22-155715.png" type="image/jpeg">
                                                                <img src="/wp-content/uploads/2024/04/Screenshot-2024-04-22-155715.png" alt="">
                                                            </picture>
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="courseAccordion-collapseNineB" class="accordion-collapse collapse" aria-labelledby="courseAccordion-headingNineB" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body io-grid-gap-200 io-mobile-grid-gap-100">
                                                    ...
                                                    <div class="io-grid io-grid-gap-075">
                                                        <div class="io-heart">
                                                            <span>Купленные уроки не имеют ограничения по времени использования.</span>
                                                        </div>
                                                        <div class="io-heart">
                                                            <span>Их можно применять для любых доступных курсов.</span>
                                                        </div>
                                                        <div class="io-heart">
                                                            <span>Приобретённые уроки доступны для всех членов вашей семьи.</span>
                                                        </div>
                                                        <div class="io-heart">
                                                            <span>Мы просим вас уведомлять нас об отмене урока минимум за 24 часа до начала, в противном случае урок будет считаться проведенным.</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="io-accordion accordion" id="courseAccordionMain">
                                        <div class="io-accordion__item accordion-item">
                                            ...
                                            <div id="courseAccordion-collapseOne" class="accordion-collapse collapse show" aria-labelledby="courseAccordion-headingOne" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body io-course-accordion__target">
                                                    ...
                                                    <div class="io-content">
                                                        Master both basic and advanced bass playing techniques, learn proper hand and finger positioning, and develop groove and rhythmic support skills.
                                                    </div>
                                                    <div class="io-check">
                                                        <span class="io-fw-semibold">Music Notation and Tablature</span>
                                                    </div>
                                                    <div class="io-content">
                                                        Study bass guitar notes and tablatures, and familiarize yourself with musical symbols and terminology.
                                                    </div>
                                                    <div class="io-check">
                                                        <span class="io-fw-semibold">Artistry</span>
                                                    </div>
                                                    <div class="io-content">
                                                        Enhance the performance of musical pieces across various genres, improve technical skills and expressive execution.
                                                    </div>
                                                    <div class="io-check">
                                                        <span class="io-fw-semibold">Stage Experience</span>
                                                    </div>
                                                    <div class="io-content">
                                                        Gain experience performing at music events and festivals, strengthen stage confidence and public performance skills, and learn how to effectively collaborate within a band.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="io-accordion__item accordion-item">
                                            ...
                                            <div id="courseAccordion-collapseTwo" class="accordion-collapse collapse" aria-labelledby="courseAccordion-headingTwo" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body">
                                                    <div class="io-content">
                                                        Our teaching methodology for bass guitar is based on unique approaches developed by our educational institution. It includes setting specific goals at the beginning of the course, achieved through systematic and methodical training. The primary objective is professional performance of bass parts in various musical styles at concerts or festivals, both solo and as part of a musical group.
                                                    </div>
                                                    <div class="io-fw-semibold io-fs-20 mt-1 mt-sm-0">
                                                        Benefits of Our Methodology
                                                    </div>
                                                    <div class="io-check">
                                                        <span>Students clearly understand the educational goals they are aiming for.</span>
                                                    </div>
                                                    <div class="io-check">
                                                        <span>The course duration is tailored to the individual learning pace of the student.</span>
                                                    </div>
                                                    <div class="io-check">
                                                        <span>Instead of exams, students showcase their skills in live performances.</span>
                                                    </div>
                                                    <div class="io-check">
                                                        <span>The methodology is suitable for both beginners and experienced musicians.</span>
                                                    </div>
                                                    <div class="io-check">
                                                        <span>After achieving initial goals, opportunities for further training to deepen skills are offered.</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="courseAccordion-collapseFive" class="accordion-collapse collapse" aria-labelledby="courseAccordion-headingFive" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body io-grid-gap-150 io-mobile-grid-gap-100">
                                                    <div class="io-icon-with-text">
                                                        ...
                                                        <div class="io-icon-with-text__content">
                                                            <p><strong>Bass Guitar and Amplifier:</strong> You will need a bass guitar and an amplifier for online lessons. A cable to connect the bass guitar to the amplifier is also essential.</p>
                                                        </div>
                                                    </div>
                                                    <div class="io-icon-with-text">
                                                        <div class="io-icon-with-text__img">
                                                        ...
                                                        <div class="io-icon-with-text__content">
                                                            <p><strong>Device with Camera and Microphone:</strong> These are necessary for participating in online lessons. They allow your instructor to see and hear you during sessions.</p>
                                                        </div>
                                                    </div>
                                                    <div class="io-icon-with-text">
                                                        <div class="io-icon-with-text__img">
                                                        ...
                                                        <div class="io-icon-with-text__content">
                                                            <p><strong>Headphones:</strong> Using high-quality headphones will help you better hear the sound of your bass guitar and minimize external interference during lessons.</p>
                                                        </div>
                                                    </div>
                                                    <div class="io-icon-with-text">
                                                        <div class="io-icon-with-text__img">
                                                        ...
                                                        <div class="io-icon-with-text__content">
                                                            <p><strong>Sheet Music and Learning Materials:</strong> We will provide you with the necessary sheet music and materials before the lessons. You can print them out or open them on your device screen for easy reference during your sessions.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="io-accordion__item accordion-item">
                                            <h2 class="io-accordion__header accordion-header" id="courseAccordion-headingTwoB">
                                                <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#courseAccordion-collapseTwoB" aria-expanded="false" aria-controls="courseAccordion-collapseTwoB">
                                                    How to Properly Select a Bass Guitar and Amplifier
                                                </button>
                                            </h2>
                                            <div id="courseAccordion-collapseTwoB" class="accordion-collapse collapse" aria-labelledby="courseAccordion-headingTwoB" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body">
                                                    <div class="io-content">
                                                        <strong>When choosing a bass guitar, it's crucial to understand the various types and features to find an instrument that best suits your musical preferences and goals. Here are the main types of bass guitars to consider as a beginner:</strong>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Invest in Quality:</strong> Don't skimp on your bass guitar purchase. A good instrument not only delivers excellent sound but also makes the learning process more comfortable and enjoyable.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Choose a Fretted Bass:</strong> Initially, opt for a fretted instrument. Fretless basses might be interesting for experienced musicians, but they pose additional challenges for beginners.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Standard Scale:</strong> Opting for the standard 34-inch scale is recommended. This size is versatile and suitable for most musicians. Consider shorter scale basses for children or individuals of shorter stature.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Four-String Model:</strong> Start with a four-string bass guitar. It’s an ideal choice for mastering the basics. Fashion and advice might tempt you to choose a bass with more strings, but it’s best to start with the basics.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Ease of Adjustment:</strong> Choose a bass with an easy-to-manage equalizer. Complex settings might be unnecessary at the beginning.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Personal Preferences:</strong> Purchase an instrument that you like both visually and sonically. Aesthetic appeal can significantly boost your motivation.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Test and Choose Independently:</strong> Always try the instrument before buying. You will be the one playing it, so it’s crucial that it feels comfortable to you.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Wise Brand Choice:</strong> If your budget is limited, consider less well-known brands. They often offer good quality for a reasonable price, and you avoid the risk of buying a counterfeit. Well-known brands like Fender or Gibson can also be found at reasonable costs.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Precision Bass (P-Bass):</strong> One of the most classic and popular types of bass guitars. Known for its powerful and dense sound, it’s suitable for many styles, especially rock music and blues.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Jazz Bass (J-Bass):</strong> Renowned for its brighter and cleaner sound compared to the P-Bass. Its wide range of sounds makes it a popular choice among jazz and funk musicians.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Semi-Hollow:</strong> These basses combine elements of acoustic and electric basses, providing a warm resonant sound. They are excellent for jazz and blues.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Acoustic Bass with Piezo Pickups:</strong> This type of bass can be used as an acoustic instrument and also plugged into an amplifier. Ideal for small venues or ensembles.</div></div>
                                                    </div>
                                                    <div class="io-content">
                                                        <strong>Choosing a Bass Amplifier:</strong>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Power and Size:</strong> Mini-combos are suitable for home use, but larger venues will require something more powerful.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Compatibility:</strong> Guitar amplifiers are not suitable as they are not tuned to reproduce the low frequencies of the bass.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Try it in the Store:</strong> Always test the amplifier with your bass in the store to ensure sound quality.</div></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><div><strong>Bonus Tip:</strong> Give your instrument a unique name. This will boost your confidence and make your musical journey more personal and memorable, as many legendary bassists have done.</div></div>
                                                    </div>
                                                    <div class="io-content">
                                                        Considering all these components, you will be ready to make an informed choice and embark on your musical journey with your first bass guitar.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="io-accordion__item accordion-item">
                                            ...
                                            <div id="courseAccordion-collapseSix" class="accordion-collapse collapse" aria-labelledby="courseAccordion-headingSix" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body">
                                                    <div class="io-check">
                                                        <div><span><strong>2 lessons per week</strong> are necessary for achieving quick and good results.</span></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><span><strong>Regular lessons without breaks</strong> contribute to the rapid assimilation of the material and the development of performance skills on the electric guitar.</span></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><span><strong>The need for independent practice at home and the completion of teacher assignments</strong> is mandatory for all students.</span></div>
                                                    </div>
                                                    <div class="io-check">
                                                        <div><span><strong>Education requires a long time</strong> and it is important to be prepared for this.</span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="courseAccordion-collapseFour" class="accordion-collapse collapse" aria-labelledby="courseAccordion-headingFour" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body io-grid-gap-150 io-mobile-grid-gap-100">
                                                    <div class="io-icon-with-text io-icon-with-text--start">
                                                        ...
                                                        <div class="io-icon-with-text__content">
                                                            <p><strong>Independent practice</strong> at home helps to reinforce the material learned during lessons.</p>
                                                            <p><strong>Daily practice on the electric guitar for at least 20 minutes at the initial stage is recommended.</strong></p>
                                                            <p><strong>Independent lessons not only bring pleasure, but also contribute to achieving high results.</strong></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="io-accordion__item accordion-item">
                                            ...
                                            <div id="courseAccordion-collapseSeven" class="accordion-collapse collapse" aria-labelledby="courseAccordion-headingSeven" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body">
                                                    <div class="io-heart">
                                                        <div><span>Help prepare for the lesson: print out the notes, turn on the gadget and follow the link to the online lesson.</span></div>
                                                    </div>
                                                    <div class="io-heart">
                                                        <div><span>Monitor and help your child complete homework.</span></div>
                                                    </div>
                                                    <div class="io-heart">
                                        ...
                                        <div class="io-accordion__item accordion-item">
                                            ...
                                            <div id="courseAccordion-collapseNineB" class="accordion-collapse collapse" aria-labelledby="courseAccordion-headingNineB" data-bs-parent="#courseAccordionMain">
                                                <div class="io-accordion__body accordion-body io-grid-gap-200 io-mobile-grid-gap-100">
                                                    ...
                                                    <div class="io-grid io-grid-gap-075">
                                                        <div class="io-heart">
                                                            <span>Purchased lessons do not have an expiration date for use.</span>
                                                        </div>
                                                        <div class="io-heart">
                                                            <span>They can be applied to any available courses.</span>
                                                        </div>
                                                        <div class="io-heart">
                                                            <span>The lessons purchased are accessible to all members of your family.</span>
                                                        </div>
                                                        <div class="io-heart">
                                                            <span>Please inform us at least 24 hours in advance if you need to cancel a lesson; otherwise, the lesson will be considered as conducted.</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="<?php echo $ioTab2; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab2; ?>-tab">
                            ...
                            <section class="io-intersection io-course-lesson">
                                <h2 class="io-heading-2 io-course-lesson__heading">Как проходят уроки бас-гитары</h2>
                                <div class="io-video">
                                ...
                                <div class="io-steps__wrapper">
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Оборудование:</span> вам понадобится бас-гитара, усилитель, а также шнур для подключения гитары к усилителю. Кроме того, необходим компьютер, планшет или смартфон с доступом в интернет и камерой для видеозвонков.</p>
                                            ...
                                            <p><span class="io-fw-semibold">Видеоконференц-платформа:</span> Для проведения онлайн уроков бас-гитары мы используем <a href="https://zoom.us/ru/download" target="_blank" class="io-purple-main io-link">Zoom</a> или <a href="https://meet.google.com" target="_blank" class="io-purple-main io-link">Google Meet</a>. Пожалуйста, загрузите и установите необходимое приложение на ваше устройство, если оно у вас еще не установлено.</p>
                                    ...
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            ...
                                            <p><span class="io-fw-semibold">Ноты для урока,</span> если они необходимы, также будут отправлены вам заранее. Может потребоваться также распечатать табулатуры или аккорды, специфичные для бас-гитары. Распечатайте ноты до начала урока.</p>
                                            <p><span class="io-fw-semibold">Установка оборудования:</span> расположите ваше устройство так, чтобы преподаватель мог видеть не только ваше лицо, но и руки, инструмент, а также усилитель.</p>
                                    ...
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Инструкции и обратная связь:</span> ваш преподаватель по бас-гитаре даст вам конкретные указания по правильной посадке, выполнению упражнений и освоению первых музыкальных композиций.</p>
                                    ...
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p>Учитель предоставит вам ноты, записи, учебники, ссылки и прочее, что поможет вам практиковаться до следующего урока. Могут быть предоставлены видео с основными техниками игры на бас-гитаре, чтобы улучшить ваше мастерство.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps io-steps--last">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p class="io-purple-main io-fs-18 io-fw-semibold">Мы гарантируем, что онлайн уроки бас-гитары удобны и эффективны.<br>Обучение будет захватывающим и продуктивным!</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            <?php } elseif (ICL_LANGUAGE_CODE === 'en') { ?>
                            <section class="io-intersection io-course-lesson">
                                <h2 class="io-heading-2 io-course-lesson__heading">How Bass Guitar Lessons Are Conducted</h2>
                                <div class="io-video">
                                ...
                                <div class="io-steps__wrapper">
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Equipment:</span> You will need a bass guitar, an amplifier, and a cable to connect your guitar to the amplifier. Additionally, a computer, tablet, or smartphone with internet access and a video calling camera is required.</p>
                                            <p><span class="io-fw-semibold">Internet Connection:</span> Ensure that your internet connection is stable and fast, as this is crucial for the quality of the video lesson.</p>
                                            <p><span class="io-fw-semibold">Video Conference Platform:</span> We use <a href="https://zoom.us/download" target="_blank" class="io-purple-main io-link">Zoom</a> or <a href="https://meet.google.com" target="_blank" class="io-purple-main io-link">Google Meet</a> for conducting online bass guitar lessons. Please download and install the necessary app on your device if it is not already installed.</p>
                                    ...
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Lesson Link:</span> The link to the lesson will be sent to you in advance via email or messenger.</p>
                                            <p><span class="io-fw-semibold">Music Sheets:</span> If needed, music sheets, including specific bass guitar tabs or chords, will also be sent to you beforehand. Make sure to print the music sheets before the lesson begins.</p>
                                            <p><span class="io-fw-semibold">Equipment Setup:</span> Position your device so that the teacher can see not just your face, but also your hands, the instrument, and your play on the amplifier.</p>
                                            <p><span class="io-fw-semibold">Log into the Zoom or Google Meet</span> app using the lesson link a few minutes before the start to address any technical issues that may arise.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">3</div>
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Instructions and Feedback:</span> Your bass guitar teacher will provide you with specific guidance on proper posture, exercise performance, and mastering initial musical compositions.</p>
                                            <p><span class="io-fw-semibold">Questions:</span> Do not hesitate to ask your teacher questions at any point during the lesson if something is unclear.</p>
                                            <p><span class="io-fw-semibold">Practice:</span> A major portion of the lesson will be dedicated to practical playing. You will perform, and the teacher will observe, listen, and demonstrate using their own instrument.</p>
                                            <p><span class="io-fw-semibold">Teacher Demonstrations:</span> Your teacher will showcase certain segments to help you better understand how to perform them.</p>
                                            <p><span class="io-fw-semibold">Lesson Conclusion:</span> At the end of the lesson, you and your teacher will discuss the material covered, homework assignments, and the plan for the next lesson.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">4</div>
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p>Learning Materials: The teacher will provide you with music sheets, recordings, textbooks, links, and other resources to help you practice until the next lesson. Videos on basic bass guitar techniques may also be provided to enhance your skills.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps io-steps--last">
                                        <div class="io-steps__empty">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p class="io-purple-main io-fs-18 io-fw-semibold">We guarantee that online bass guitar lessons are convenient and effective. Learning will be exciting and productive!</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                        ...
                        <div class="tab-pane fade" id="<?php echo $ioTab4; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab4; ?>-tab">
                            ...
                            <section class="io-intersection io-course-programs">
                                <h2 class="io-heading-2">Программа курса бас-гитары</h2>
                                <div class="io-course-programs__grid">
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--light">
                                        <div class="io-course-programs__data io-course-programs__data--light">
                                            ...
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-none d-sm-flex">
                                                ...
                                                <picture>
                                                    ...
                                                    <source srcset="/wp-content/uploads/2024/04/Screenshot-2024-04-14-130319.png" type="image/png">
                                                    <img class="d-none" src="/wp-content/uploads/2024/04/Screenshot-2024-04-14-130319.png" alt="">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="io-course-programs__content io-course-programs__content--light">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>1</span>
                                                <p>Изучение основ техники игры на бас-гитаре: правильное положение рук, игра медиатором.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>2</span>
                                                <p>Изучение простых басовых партий. Углубленное изучение музыкальной теории и гармонии.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>3</span>
                                                <p>Овладение упражнениями для развития техники.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>4</span>
                                                <p>Изучение сложных басовых линий и мелодий. Приобретение технических навыков перебора и слэпа.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>5</span>
                                                <p>Изучение произведений различных стилей музыки (джаз, блюз, рок, поп, фанк).</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>6</span>
                                                <p>Подготовка программы и выступление на концерте.</p>
                                            </div>
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--medium">
                                        <div class="io-course-programs__data io-course-programs__data--medium">
                                            ...
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-none d-sm-flex">
                                                ...
                                                <picture>
                                                    ...
                                                    <source srcset="/wp-content/uploads/2024/04/Screenshot-2024-04-14-130346.png" type="image/png">
                                                    <img class="d-none" src="/wp-content/uploads/2024/04/Screenshot-2024-04-14-130346.png" alt="">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="io-course-programs__content io-course-programs__content--medium">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>7</span>
                                                <p>Игра в ансамбле: взаимодействие с другими музыкантами. </p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>8</span>
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>9</span>
                                                <p>Получение навыков импровизации. Овладение продвинутыми техниками: сложные паттерны, быстрые переборы, сложные ритмы.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>10</span>
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--hard">
                                        <div class="io-course-programs__data io-course-programs__data--hard">
                                            ...
                                            <a href="#" target="_blank" class="io-course-programs__diploma io-lightbox d-none d-sm-flex">
                                                ...
                                                <picture>
                                                    ...
                                                    <source srcset="/wp-content/uploads/2024/04/Screenshot-2024-04-14-130402.png" type="image/png">
                                                    <img class="d-none" src="/wp-content/uploads/2024/04/Screenshot-2024-04-14-130402.png" alt="">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="io-course-programs__content io-course-programs__content--hard">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>11</span>
                                                <p>Изучение произведений различных стилей и сложных технических приемов.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>12</span>
                                                <p>Работа над сложными произведениями и интерпретацией.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>13</span>
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>14</span>
                                                <p>Подготовка к живым выступлениям: работа на сцене, коммуникация с публикой, техника безопасности. Заключительный концерт.</p>
                                            </div>
                                ...
                                <div class="io-text-wrapper">
                                    <p>Курс обучения игре на бас-гитаре предназначен для начинающих студентов от 10 лет и взрослых любого возраста, стремящихся освоить этот уникальный инструмент. Структура курса разделена на три основных этапа: начальный, средний и продвинутый, каждый из которых завершается вручением диплома. На старте начального этапа учащиеся знакомятся с азами музыки и техникой игры на бас-гитаре с нуля, даже если они никогда не держали в руках музыкальных инструментов. Средний и продвинутый уровни предполагают наличие базовых знаний и умений.</p>
                                    <p>Для юных музыкантов в возрасте от 5 до 10 лет мы рекомендуем начать с классической гитары. Это позволит развить необходимые технику и освоить постановку рук, а также создаст прочную основу для будущего изучения бас-гитары, облегчая переход к более специализированным техникам и стилям игры.</p>
                            ...
                            <?php } elseif (ICL_LANGUAGE_CODE === 'en') { ?>
                            <section class="io-intersection io-course-programs">
                                <h2 class="io-heading-2">Bass Guitar Course Program</h2>
                                <div class="io-course-programs__grid">
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--light">
                                        ...
                                        <div class="io-course-programs__content io-course-programs__content--light">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>1</span>
                                                <p>Learning the basics of bass guitar technique: correct hand positioning, playing with a pick.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>2</span>
                                                <p>Studying simple bass parts. In-depth study of musical theory and harmony.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>3</span>
                                                <p>Mastering exercises to develop technique.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>4</span>
                                                <p>Learning complex bass lines and melodies. Acquiring technical skills in fingerstyle and slap techniques.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>5</span>
                                                <p>Studying pieces from various music styles (jazz, blues, rock, pop, funk).</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>6</span>
                                                <p>Preparing a performance program and performing in a concert.</p>
                                            </div>
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--medium">
                                        ...
                                        <div class="io-course-programs__content io-course-programs__content--medium">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>7</span>
                                                <p>Ensemble play: interacting with other musicians.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>8</span>
                                                <p>Studying intermediate difficulty pieces.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>9</span>
                                                <p>Gaining improvisation skills. Mastering advanced techniques: complex patterns, fast fingerstyle, complex rhythms.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>10</span>
                                                <p>Studying and performing solo and ensemble pieces.</p>
                                            </div>
                                    ...
                                    <div class="io-course-programs__inner io-course-programs__inner--hard">
                                        ...
                                        <div class="io-course-programs__content io-course-programs__content--hard">
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>11<span>
                                                <p>Studying pieces of various styles and complex technical techniques.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>12<span>
                                                <p>Working on complex pieces and interpretation.</p>
                                            </div>
                                            <div class="io-course-programs__item">
                                                <span>13<span>
                                            ...
                                            <div class="io-course-programs__item">
                                                <span>14<span>
                                                <p>Preparing for live performances: stage work, audience communication, safety techniques. Final concert.</p>
                                            </div>
                                ...
                                <div class="io-text-wrapper">
                                    <p>The bass guitar learning course is designed for beginners aged 10 and up, including adults of any age, who are keen to master this unique instrument. The course structure is divided into three main stages: beginner, intermediate, and advanced, each culminating in the awarding of a diploma. At the beginning stage, students are introduced to the fundamentals of music and bass guitar playing techniques from scratch, even if they have never held a musical instrument before. The intermediate and advanced levels require basic knowledge and skills.</p>
                                    <p>For young musicians aged 5 to 10, we recommend starting with classical guitar. This approach will help develop the necessary techniques and hand positioning, as well as lay a solid foundation for future bass guitar learning, easing the transition to more specialized techniques and styles of play.</p>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioGiftCourseCheck-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="ioGiftCourseCheck-headingTwo">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-radio" type="radio" id="iocheckboxgift26" name="checkbox-group" checked>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioDemoCourseCheck-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="ioDemoCourseCheck-headingTwo">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-checkbox" type="checkbox" id="iocheckbox26" name="checkbox-group" checked>
                                ...
                                <div class="io-accordion accordion" id="faqAccodrion">
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-1">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-1" aria-expanded="false" aria-controls="faqAccordion-collapse-1">
                                                Как записаться на курс бас-гитары онлайн?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-1" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-1" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Записаться на пробный урок бас-гитары и оплатить его можно <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType2">здесь</a>. После этого наш администратор свяжется с вами и согласует расписание.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2" aria-expanded="false" aria-controls="faqAccordion-collapse-2">
                                                С какого возраста можно учиться детям на курсе бас-гитары онлайн?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-2b" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2b" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Пробный урок бас-гитары стоит <span class="ioArrayToTextElementsDemo">$6</span>. Стоимость пробных уроков на все курсы одинаковая.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-3">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-3" aria-expanded="false" aria-controls="faqAccordion-collapse-3">
                                                Сколько стоит обучение на бас-гитаре? Есть ли скидки?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-7">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-7" aria-expanded="false" aria-controls="faqAccordion-collapse-7">
                                                Сколько длится урок бас-гитары?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-7" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-7" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Урок бас-гитары длится 45 минут.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-8" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-8" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Нет, уроки бас-гитары проходят только индивидуально.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-9">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-9" aria-expanded="false" aria-controls="faqAccordion-collapse-9">
                                                Я никогда не учился ранее играть на басу, я могу записаться к вам? 
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-9" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-9" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Да, мы начинаем обучение игре на басу с нуля.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-10" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-10" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Да, наш педагог бас-гитары определит уровень знаний и подберет программу соответствующего уровня сложности. 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-13" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-13" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Да, можно приостановить абонемент на любой период, сообщите нам даты ваших каникул.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-21" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-21" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    К сожалению, да. В случае несвоевременного сообщения об отсутствии, урок будет считаться состоявшимся и мы оплатим время учителю.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-22">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-22" aria-expanded="false" aria-controls="faqAccordion-collapse-22">
                                                Есть ли срок использования купленных уроков? 
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-14">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-14" aria-expanded="false" aria-controls="faqAccordion-collapse-14">
                                                Получит ли мой ребенок диплом об окончании курса бас-гитары?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-15">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-15" aria-expanded="false" aria-controls="faqAccordion-collapse-15">
                                                Как нужно подготовиться к урокам бас-гитары?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-15" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-15" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Вам необходимо дома иметь бас-гитару, гаджет с камерой и желательно наушники. Загрузите на ваше устройство приложение Zoom и Google Meet, проверьте работу камеры и звука.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-18">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-18" aria-expanded="false" aria-controls="faqAccordion-collapse-18">
                                                Могу ли я сам выбрать преподавателя бас-гитары на вашем сайте? 
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-18" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-18" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Да. При этом важно, чтобы ваши пожелания по расписанию совпали с рабочим графиком этого учителя бас-гитары. 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-19">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-19" aria-expanded="false" aria-controls="faqAccordion-collapse-19">
                                                Включает ли курс бас-гитары изучение теории музыки? 
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-19" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-19" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Да, включает. На уроках бас-гитары педагог обязательно уделяет внимание теории музыки. 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-20">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-20" aria-expanded="false" aria-controls="faqAccordion-collapse-20">
                                                Есть ли программа курса бас-гитары и можно ли ее посмотреть?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-20" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-20" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Да, программа курса бас-гитары онлайн опубликована на сайте на странице курса.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <section class="io-intersection io-course-faq">
                                ...
                                <div class="io-accordion accordion" id="faqAccodrion">
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-1">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-1" aria-expanded="false" aria-controls="faqAccordion-collapse-1">
                                                How to Enroll in an Online Bass Guitar Course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-1" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-1" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    You can sign up for a trial bass guitar lesson and pay for it <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType2">here</a>. Afterward, our administrator will contact you to schedule your lessons.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2" aria-expanded="false" aria-controls="faqAccordion-collapse-2">
                                                What is the Minimum Age for Children to Join the Online Bass Guitar Course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    We welcome children from the age of 10.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-2b" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2b" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    The trial bass guitar lesson costs <span class="ioArrayToTextElementsDemo">$6</span>. The cost is the same for trial lessons across all courses.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-3">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-3" aria-expanded="false" aria-controls="faqAccordion-collapse-3">
                                                What are the Fees for Bass Guitar Lessons? Are There Any Discounts?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-3" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-3" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    You need to purchase a subscription for at least 4 lessons, costing <span class="ioArrayToTextElements03">$56</span>. You can select the number of lessons <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType1">here</a>. A discount of <span class="ioArrayToTextElements62">$120</span> is available for purchasing 80 lessons in one payment.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-4">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-4" aria-expanded="false" aria-controls="faqAccordion-collapse-4">
                                                How to Pay for the Bass Guitar Course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-4" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-4" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-5">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-5" aria-expanded="false" aria-controls="faqAccordion-collapse-5">
                                                How Often Do Online Bass Guitar Lessons Take Place?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-5" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-5" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    We recommend practicing at least twice a week.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-6" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-6" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    The lesson schedule is individually agreed upon with each student.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-7">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-7" aria-expanded="false" aria-controls="faqAccordion-collapse-7">
                                                How Long Does a Bass Guitar Lesson Last?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-7" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-7" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Each bass guitar lesson lasts for 45 minutes.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-8" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-8" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    No, bass guitar lessons are conducted on an individual basis only.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-9">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-9" aria-expanded="false" aria-controls="faqAccordion-collapse-9">
                                                I Have Never Learned to Play the Bass Before. Can I Enroll?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-9" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-9" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, we start teaching bass guitar from scratch.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-10" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-10" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, our bass guitar teacher will assess the student's level of knowledge and select an appropriately challenging program.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-12" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-12" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    To preserve your payment, you must notify us of your absence at least 24 hours before the lesson starts.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-13" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-13" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, you can pause your subscription for any period; just inform us of your holiday dates.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-21" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-21" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Unfortunately, yes. If we are not notified in time about the absence, the lesson is considered to have taken place, and we will pay the teacher for their time.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-14">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-14" aria-expanded="false" aria-controls="faqAccordion-collapse-14">
                                                Will My Child Receive a Diploma Upon Completion of the Bass Guitar Course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-14" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-14" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-15">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-15" aria-expanded="false" aria-controls="faqAccordion-collapse-15">
                                                How Should I Prepare for Bass Guitar Lessons?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-15" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-15" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    You need to have a bass guitar at home, a gadget with a camera, and preferably headphones. Download the Zoom and Google Meet applications on your device, and check the camera and sound are working.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-23" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-23" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    At the Montessori Center, instead of exams, students perform in concerts and participate in online competitions.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-25">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-25" aria-expanded="false" aria-controls="faqAccordion-collapse-25">
                                                Can I Choose a Bass Guitar Teacher on Your Website?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-25" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-25" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes. It is important that your schedule preferences match the working hours of the chosen bass guitar teacher.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-26">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-26" aria-expanded="false" aria-controls="faqAccordion-collapse-26">
                                                Does the Bass Guitar Course Include Music Theory?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-26" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-26" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, it does. Music theory is an essential part of the bass guitar lessons.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-27">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-27" aria-expanded="false" aria-controls="faqAccordion-collapse-27">
                                                Is There a Curriculum for the Bass Guitar Course Available for Review?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-27" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-27" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, the online bass guitar course curriculum is published on the course page on our website.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    var scrollImageRu = '/wp-content/uploads/2023/11/Бас-гитара-Онлайн.svg';
    var scrollImageEn = '/wp-content/uploads/2023/11/Bass-Guitar-Online.svg';
