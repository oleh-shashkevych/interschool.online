 ...
 * Template Name: Курс Комп графика
 */
    ...
    if (ICL_LANGUAGE_CODE === 'ru') {
        ...
        $contentTab3 = '
            <section class="io-intersection io-course-lectors">
                <h2 class="io-heading-2 io-course-lectors__heading">Преподаватели компьютерной графики</h2>
                <div class="io-course-lectors__text-wrapper io-text-wrapper">
                    <div class="io-check io-check--start">
                        <span>Преподаватели курса компьютерной графики — это опытные профессионалы и признанные эксперты в области графического дизайна, которые поделятся не только знаниями, но и реальным опытом работы в индустрии. </span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Каждому студенту предоставляется возможность работать над собственными проектами, что позволяет приобретать необходимые навыки и сразу же применять их на практике.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Обучение на курсе компьютерной графики с учителями нашей школы поможет студентам подготовиться к карьере в различных сферах — от рекламы и маркетинга до кинематографии и видеоигр.</span>
                    </div>
        ...
        $contentTab3 = '
            <section class="io-intersection io-course-lectors">
                <h2 class="io-heading-2 io-course-lectors__heading">Computer Graphics Teachers</h2>
                <div class="io-course-lectors__text-wrapper io-text-wrapper">
                    <div class="io-check io-check--start">
                        <span>The teachers of our computer graphics course are experienced professionals and recognized experts in the field of graphic design. They share not only their knowledge but also their real-world industry experience.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Each student is given the opportunity to work on their own projects, allowing them to acquire essential skills and apply them in practice immediately.</span>
                    </div>
                    <div class="io-check io-check--start">
                        <span>Studying computer graphics with our school’s teachers will help students prepare for careers in various fields—from advertising and marketing to cinematography and video games.</span>
                    </div>
                </div>
                <div class="io-course-lectors__item io-block">
                    <div class="io-course-lectors__item-header">
                    ...
                    <div class="io-sidebar__inner">
                        <section class="io-course-passport">
                            ...
                            <div class="io-course-passport__header">
                                <span class="io-course-passport__header-title"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Курс компьютерной графики'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Computer graphics course'; } ?></span>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="<?php echo $ioTab1; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab1; ?>-tab">
                            <div>
                                <section class="io-intersection io-course-hero">
                                    <h1 class="io-heading-1 io-course-hero__heading"><?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'Уроки<br><span class="io-pink-main">Компьютерной Графики</span><br>Oнлайн'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'Online<br><span class="io-pink-main">Computer Graphics</span><br>Lessons'; } ?></h1>
                                    ...
                                    <div class="io-course-hero__rating io-rating">
                                        ...
                                        <div class="io-rating__bottom">
                                            <div class="io-rating__bottom-left">
                                                ...
                                                <span>+96 <?php if (ICL_LANGUAGE_CODE === 'ru') { echo 'отзывов'; } elseif (ICL_LANGUAGE_CODE === 'en') { echo 'reviews'; } ?></span>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="<?php echo $ioTab2; ?>" role="tabpanel" aria-labelledby="<?php echo $ioTab2; ?>-tab">
                            ...
                            <section class="io-intersection io-course-lesson">
                                <h2 class="io-heading-2 io-course-lesson__heading">Как проходят уроки компьютерной графики</h2>
                                <div class="io-video">
                                ...
                                <div class="io-steps__wrapper">
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Оборудование:</span> для участия в онлайн-уроках компьютерной графики вам потребуется графический планшет, который подключается к ноутбуку или компьютеру или обычный планшет на операционной системе Android или iOS, а также стилус (специальный карандаш для рисования на планшете). Для начинающих студентов лучше всего подойдет обычный планшет на операционной системе Android или iOS.</p>
                                            <p><span class="io-fw-semibold">Интернет-соединение:</span> стабильное и быстрое интернет-соединение необходимо для бесперебойного доступа к видеоурокам и онлайн-ресурсам. Рекомендуется проверить скорость интернета перед началом занятий.</p>
                                            <p><span class="io-fw-semibold">Платформа для видеоконференций:</span> занятия проводятся через такие платформы, как Zoom или Google Meet. Установите необходимое программное обеспечение заранее и убедитесь, что все функции видео и аудио работают корректно.</p>
                                            <p><span class="io-fw-semibold">Звук:</span> наушники с микрофоном помогут вам лучше слышать преподавателя, а также избавят от посторонних шумов во время урока.</p>
                                            <p><span class="io-fw-semibold">Освещение и рабочее место:</span> позаботьтесь о хорошем освещении вашей рабочей зоны. Яркий, но рассеянный свет поможет избежать бликов на экране и усталости глаз.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Получение ссылки на урок:</span> ссылка на онлайн-занятие будет отправлена вам заблаговременно по электронной почте или через предпочитаемый мессенджер. Убедитесь, что вы получили ссылку за день до начала урока.</p>
                                            <p><span class="io-fw-semibold">Материалы для урока:</span> Программное обеспечение: установите необходимые программы для работы с графикой: для планшетов на iOS понадобится программа Procreate, а для планшетов на Android - программа MediBang Paint Pro. Загрузите и установите нужную программу заранее до урока. Аксессуары: подготовьте графический планшет, подключите его к компьютеру или ноутбуку. Если вы используете обычный планшет,  убедитесь, что он хорошо заряжен.</p>
                                            <p><span class="io-fw-semibold">Настройка рабочего места:</span> Размещение устройства: расположите ваш компьютер или ноутбук таким образом, чтобы камера и микрофон были направлены на вас. Это важно для обеспечения взаимодействия с преподавателем. Тестирование техники: За 5-10 минут до начала урока войдите в выбранное приложение для видеоконференций по полученной ссылке. Проверьте, что ваша камера, микрофон и интернет-соединение работают без сбоев.</p>
                                            <p>Эти шаги помогут вам максимально эффективно настроиться на предстоящее занятие по компьютерной графике.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Инструкции и обратная связь:</span> ваш преподаватель по компьютерной графике предоставит подробные инструкции по использованию различных графических программ и инструментов. Вы получите ценную обратную связь, которая поможет вам развивать свои технические навыки и творческое видение.</p>
                                            <p><span class="io-fw-semibold">Задавайте вопросы:</span> не стесняйтесь обращаться к преподавателю с вопросами о сложностях, с которыми вы столкнулись, или о любых нюансах использования программ. Преподаватель готов помочь вам в разрешении всех ваших вопросов.</p>
                                            <p><span class="io-fw-semibold">Практика:</span> основная часть урока будет посвящена практической работе в графических редакторах. Вы будете создавать собственные проекты, в то время как преподаватель будет следить за вашим процессом и предлагать способы улучшения ваших работ.</p>
                                            <p><span class="io-fw-semibold">Демонстрация преподавателем:</span> преподаватель будет демонстрировать создание графических проектов в реальном времени, объяснять процесс и делиться советами по достижению наилучших результатов цифровой иллюстрации.</p>
                                            <p><span class="io-fw-semibold">Завершение урока:</span> в конце занятия вы сможете обсудить с преподавателем изученные приёмы, получить задания для самостоятельной работы и обговорить планы на следующие уроки.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p>Материалы для самостоятельной работы: преподаватель предоставит вам рекомендации по использованию графических инструментов, примеры успешных проектов и дополнительные ресурсы для углубленного изучения компьютерной графики.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps io-steps--last">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p class="io-purple-main io-fs-18 io-fw-semibold">Мы уверены, что онлайн-уроки компьютерной графики помогут вам комфортно и результативно освоить необходимые навыки. Ваше обучение будет интересным и плодотворным!</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            <?php } elseif (ICL_LANGUAGE_CODE === 'en') { ?>
                            <section class="io-intersection io-course-lesson">
                                <h2 class="io-heading-2 io-course-lesson__heading">How Computer Graphics Lessons Work</h2>
                                <div class="io-video">
                                ...
                                <div class="io-steps__wrapper">
                                    <div class="io-steps">
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Equipment:</span> For participating in online computer graphics classes, you will need a graphics tablet connected to a laptop or computer or a regular tablet with Android or iOS operating systems, along with a stylus. For beginners, a regular Android or iOS tablet is often best.</p>
                                            <p><span class="io-fw-semibold">Internet Connection:</span> A stable and fast internet connection is crucial for uninterrupted access to video lessons and online resources. It is recommended to check your internet speed before starting the classes.</p>
                                            <p><span class="io-fw-semibold">Video Conferencing Platform:</span> Classes are conducted via platforms such as Zoom or Google Meet. Install the necessary software in advance and ensure that all video and audio functions are working correctly.</p>
                                            <p><span class="io-fw-semibold">Sound:</span> Headphones with a microphone will help you hear the teacher better and reduce ambient noise during the lesson.</p>
                                            <p><span class="io-fw-semibold">Lighting and Workspace:</span> Ensure your workspace is well-lit. Bright, diffused light will help avoid screen glare and reduce eye strain.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">2</div>
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Receiving the Lesson Link:</span> The link to the online session will be sent to you in advance via email or your preferred messenger. Ensure that you receive the link a day before the lesson starts.</p>
                                            <p><span class="io-fw-semibold">Lesson Materials:</span> Software: Install necessary graphic design software—Procreate for iOS tablets, and MediBang Paint Pro for Android tablets. Download and install the required software before the lesson. Accessories: Prepare your graphics tablet and connect it to your computer or laptop. If using a regular tablet, ensure it is fully charged. Workspace: Make sure your desk is comfortable and uncluttered to create optimal learning conditions.</p>
                                            <p><span class="io-fw-semibold">Workspace Setup:</span> Device Placement: Position your computer or laptop so that the camera and microphone are facing you. This is crucial for interactive sessions with your teacher. Technical Testing: Enter the video conferencing application via the provided link 5-10 minutes before the lesson starts. Check that your camera, microphone, and internet connection are functioning without interruptions.</p>
                                            <p>These steps will help you optimally prepare for your upcoming computer graphics lesson.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">3</div>
                                        ...
                                        <div class="io-steps__dots"></div>
                                        <div class="io-steps__text io-text-wrapper">
                                            <p><span class="io-fw-semibold">Instructions and Feedback:</span> Your teacher will provide detailed instructions on using various graphic design programs and tools. You will receive valuable feedback that will help develop your technical skills and creative vision.</p>
                                            <p><span class="io-fw-semibold">Ask Questions:</span> Do not hesitate to ask your teacher about any difficulties you encounter or any nuances in using the programs. The teacher is there to help you resolve all your queries.</p>
                                            <p><span class="io-fw-semibold">Practice:</span> The main part of the lesson will be dedicated to practical work in graphic editors. You will create your own projects while the teacher monitors your progress and suggests ways to improve your work.</p>
                                            <p><span class="io-fw-semibold">Teacher Demonstrations:</span> The teacher will demonstrate graphic project creation in real-time, explaining the process and sharing tips for achieving the best results in digital illustration.</p>
                                            <p><span class="io-fw-semibold">Lesson Conclusion:</span> At the end of the session, you will discuss the techniques learned, receive assignments for independent practice, and talk about plans for future lessons.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps">
                                        <div class="io-steps__number">4</div>
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p>Materials for Independent Work: The teacher will provide you with guidelines on using graphic tools, examples of successful projects, and additional resources for in-depth study of computer graphics.</p>
                                        </div>
                                    </div>
                                    <div class="io-steps io-steps--last">
                                        <div class="io-steps__empty">
                                        ...
                                        <div class="io-steps__text io-text-wrapper">
                                            <p class="io-purple-main io-fs-18 io-fw-semibold">We are confident that online computer graphics lessons will help you comfortably and effectively master the necessary skills. Your learning experience will be engaging and productive!</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioGiftCourseCheck-collapseOne" class="accordion-collapse collapse show" aria-labelledby="ioGiftCourseCheck-headingOne">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-radio" type="radio" id="iocheckboxgift13" name="checkbox-group" checked>
                                                        ...
                                                        <div class="io-accordion__item accordion-item">
                                                            ...
                                                            <div id="ioDemoCourseCheck-collapseOne" class="accordion-collapse collapse show" aria-labelledby="ioDemoCourseCheck-headingOne">
                                                                <div class="io-block io-block--grey io-accordion__body accordion-body">
                                                                    ...
                                                                    <div>
                                                                        <input class="io-checkbox" type="checkbox" id="iocheckbox13" name="checkbox-group" checked>
                                ...
                                <div class="io-accordion accordion" id="faqAccodrion">
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-1">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-1" aria-expanded="false" aria-controls="faqAccordion-collapse-1">
                                                Как записаться на курс компьютерной графики онлайн? 
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-1" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-1" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Записаться на пробный урок компьютерной графики и оплатить его можно <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType2">здесь</a>. После этого наш администратор свяжется с вами и согласует день недели и время пробного урока. 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2" aria-expanded="false" aria-controls="faqAccordion-collapse-2">
                                                С какого возраста можно учиться детям на курсе компьютерной графики онлайн? 
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    На курс компьютерной графики мы приглашаем детей от 7 лет.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2b">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2b" aria-expanded="false" aria-controls="faqAccordion-collapse-2b">
                                                Как нужно подготовиться к урокам компьютерной графики?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2b" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2b" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Вам необходимо дома иметь графический планшет или обычный планшет (IPad или Android) и стилус (специальный карандаш для рисования на планшете). Также загрузите на ваше устройство приложение Zoom и Google Meet, проверьте работу камеры и звука. Кроме этого понадобится программное обеспечение, в котором будет работать студент: для планшетов на IOS - программа Procreate, а для планшетов на Android - программа MediBang Paint Pro. Загрузите и установите нужную программу заранее до урока.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-3" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-3" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Пробный урок компьютерной графики стоит <span class="ioArrayToTextElementsDemo">$6</span>. Стоимость пробных уроков на все курсы одинаковая.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-6">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-6" aria-expanded="false" aria-controls="faqAccordion-collapse-6">
                                                Сколько раз в неделю проходят уроки компьютерной графики онлайн? 
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-6" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-6" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Мы рекомендуем заниматься 2 раза в неделю, но вы можете сами регулировать частоту уроков, в зависимости от вашего личного расписания. 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-8" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-8" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Индивидуальный урок компьютерной графики длится 45 минут.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-9" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-9" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Нет, уроки компьютерной графики проходят только индивидуально.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-11">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-11" aria-expanded="false" aria-controls="faqAccordion-collapse-11">
                                                Мой ребенок раньше занимался компьютерной графикой, вы определите его умения?
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-16">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-16" aria-expanded="false" aria-controls="faqAccordion-collapse-16">
                                                Будет ли мой ребенок сдавать какие-либо экзамены, зачеты? 
                                            </button>
                                        </h2>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-19">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-19" aria-expanded="false" aria-controls="faqAccordion-collapse-19">
                                                Есть ли программа курса компьютерной графики и можно ли ее посмотреть?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-19" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-19" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Да, программа курса компьютерной графики опубликована на сайте на странице курса.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <section class="io-intersection io-course-faq">
                                ...
                                <div class="io-accordion accordion" id="faqAccodrion">
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-1">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-1" aria-expanded="false" aria-controls="faqAccordion-collapse-1">
                                                How to Enroll in an Online Computer Graphics Course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-1" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-1" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    You can sign up for a trial computer graphics lesson and pay for it <a type="button" class="io-link io-button__tab-switch" data-tab-id-switch="<?php echo $ioTab6; ?>" data-radio-id-switch="ioCourseType2">here</a>. Our administrator will then contact you to arrange the day of the week and time for the trial lesson.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2" aria-expanded="false" aria-controls="faqAccordion-collapse-2">
                                                What is the minimum age for children to attend the online computer graphics course?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    We invite children from the age of 7 to join the computer graphics course.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-2b">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-2b" aria-expanded="false" aria-controls="faqAccordion-collapse-2b">
                                                How should I prepare for the computer graphics lessons?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-2b" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-2b" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    You will need to have either a graphics tablet or a standard tablet (iPad or Android) and a stylus (special pencil for drawing on a tablet) at home. Also, download the Zoom and Google Meet applications on your device, check your camera and sound. Additionally, you will need software that the student will use: for iOS tablets, the Procreate app, and for Android tablets, the MediBang Paint Pro app. Please download and install the necessary software before the lesson.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-3" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-3" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    The trial computer graphics lesson costs <span class="ioArrayToTextElementsDemo">$6</span>. The cost for trial lessons is the same across all courses.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-6">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-6" aria-expanded="false" aria-controls="faqAccordion-collapse-6">
                                                How often are the online computer graphics lessons held?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-6" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-6" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    We recommend attending twice a week, but you can adjust the frequency of lessons according to your personal schedule.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-8" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-8" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    An individual computer graphics lesson lasts 45 minutes.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="io-accordion__item accordion-item">
                                        ...
                                        <div id="faqAccordion-collapse-9" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-9" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    No, computer graphics lessons are only conducted individually.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-11">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-11" aria-expanded="false" aria-controls="faqAccordion-collapse-11">
                                                My child has previously engaged in computer graphics; will you assess their skills?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-11" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-11" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-16">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-16" aria-expanded="false" aria-controls="faqAccordion-collapse-16">
                                                Will my child have to take any exams or assessments?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-16" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-16" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                    ...
                                    <div class="io-accordion__item accordion-item">
                                        <h2 class="io-accordion__header accordion-header" id="faqAccordion-heading-19">
                                            <button class="io-accordion__button accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqAccordion-collapse-19" aria-expanded="false" aria-controls="faqAccordion-collapse-19">
                                                Is there a program for the computer graphics course available to view?
                                            </button>
                                        </h2>
                                        <div id="faqAccordion-collapse-19" class="accordion-collapse collapse" aria-labelledby="faqAccordion-heading-19" data-bs-parent="#faqAccodrion">
                                            <div class="io-accordion__body accordion-body">
                                                <div class="io-block io-block--grey io-course-faq__item">
                                                    Yes, the computer graphics course program is published on our website on the course page.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    var scrollImageRu = '/wp-content/uploads/2023/11/Компьютерная-графика-Онлайн.svg';
    var scrollImageEn = '/wp-content/uploads/2023/11/Computer-Graphics-Online.svg';
